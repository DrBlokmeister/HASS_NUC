const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./plugin-CZUSM5PU.js","./vendor-DZIGv750.js","./yaml-engine-Y8S_KLr6.js","./plugin-Disn2X9z.js","./plugin-B_ZV41ek.js","./plugin-CP6dZvV0.js","./plugin-Cx1qSmIb.js","./plugin-BFOC_hck.js","./mdi-icons-CTSt1Fdj.js","./text_utils-DPZlj6Oi.js","./plugin-DKLjCAlv.js","./plugin-BIQagZfS.js","./plugin-CINDJMa3.js","./plugin-DIexz7Kc.js","./plugin-CzsdLprx.js","./plugin-D_AfduZE.js","./plugin-CTHmnWFz.js","./plugin-DoThr8QU.js","./plugin-6toyWDvZ.js","./plugin-BkAUpZV9.js","./plugin-B8VbK5dX.js","./template_converter-xh6TZI7e.js","./plugin-UP2KZLdm.js","./plugin-DpCISaL3.js","./plugin-YtesyQcr.js","./fillable_shape-DjT6BoV_.js","./plugin-BEpM-68d.js","./plugin-DkYQT7Pj.js","./plugin-BJQWWSpp.js","./plugin-Na6MDPl9.js","./plugin-DhaDK0W9.js","./plugin-CueK5FGE.js","./plugin-7mK5DIiS.js","./plugin-1mDNoZbi.js","./plugin-C5PIVSXT.js","./shared-CG-Iex5A.js","./plugin-utaFEZPt.js","./plugin-C-3D7rUt.js"])))=>i.map(i=>d[i]);
import"./vendor-DZIGv750.js";import{l as ue,H as li,p as cn,h as Ge}from"./yaml-engine-Y8S_KLr6.js";const di="modulepreload",ci=function(t,e){return new URL(t,e).href},Ht={},T=function(e,n,i){let o=Promise.resolve();if(n&&n.length>0){const a=document.getElementsByTagName("link"),s=document.querySelector("meta[property=csp-nonce]"),l=s?.nonce||s?.getAttribute("nonce");o=Promise.allSettled(n.map(c=>{if(c=ci(c,i),c in Ht)return;Ht[c]=!0;const d=c.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(!!i)for(let m=a.length-1;m>=0;m--){const f=a[m];if(f.href===c&&(!d||f.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${c}"]${u}`))return;const g=document.createElement("link");if(g.rel=d?"stylesheet":di,d||(g.as="script"),g.crossOrigin="",g.href=c,l&&g.setAttribute("nonce",l),document.head.appendChild(g),d)return new Promise((m,f)=>{g.addEventListener("load",m),g.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(a){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=a,window.dispatchEvent(s),!s.defaultPrevented)throw a}return o.then(a=>{for(const s of a||[])s.status==="rejected"&&r(s.reason);return e().catch(r)})},pn=new EventTarget,P={STATE_CHANGED:"state-changed",SELECTION_CHANGED:"selection-changed",WIDGET_UPDATED:"widget:updated",PAGE_CHANGED:"page-changed",HISTORY_CHANGED:"history-changed",SETTINGS_CHANGED:"settings-changed",LAYOUT_IMPORTED:"layout-imported",ENTITIES_LOADED:"entities-loaded",ZOOM_CHANGED:"zoom-changed",DEVICE_PROFILES_UPDATED:"device-profiles-updated"};function I(t,e={}){pn.dispatchEvent(new CustomEvent(t,{detail:e}))}function N(t,e){pn.addEventListener(t,n=>e(n.detail))}const pi={WHITE:"#FFFFFF",BLACK:"#000000",GRAY:"#808080",GREY:"#808080",RED:"#FF0000",GREEN:"#00FF00",BLUE:"#0000FF",YELLOW:"#FFFF00",ORANGE:"#FFA500"},ui={GRID_SIZE:10,SNAP_THRESHOLD:10,SIDEBAR_WIDTH:300,PROPERTIES_WIDTH:350},hi={X:40,Y:40,WIDTH:200,HEIGHT:60},gi={TOP_LEFT:"TOP_LEFT",TOP_CENTER:"TOP_CENTER",TOP_RIGHT:"TOP_RIGHT",CENTER_LEFT:"CENTER_LEFT",CENTER:"CENTER",CENTER_RIGHT:"CENTER_RIGHT",BOTTOM_LEFT:"BOTTOM_LEFT",BOTTOM_CENTER:"BOTTOM_CENTER",BOTTOM_RIGHT:"BOTTOM_RIGHT"},$e={LANDSCAPE:"landscape",PORTRAIT:"portrait",LANDSCAPE_INVERTED:"landscape_inverted",PORTRAIT_INVERTED:"portrait_inverted"},un={snapEnabled:!0,showGrid:!0,showConditionalWidgets:!1,showDebugGrid:!1,showRulers:!1,autoSaveEnabled:!0,gridOpacity:8,editor_light_mode:!1,ai_provider:"gemini",ai_model_filter:"",ai_model_gemini:"",ai_model_openai:"",ai_model_openrouter:"",ai_model_minimax:"",ai_model_glm:"",extendedLatinGlyphs:!1,autoCycleEnabled:!1,autoCycleIntervalS:30,refreshInterval:600,manualRefreshOnly:!1,darkMode:!1,invertedColors:null,lcdEcoStrategy:"backlight_off",dimTimeout:10,sleepEnabled:!1,sleepStartHour:0,sleepEndHour:5,deepSleepEnabled:!1,deepSleepInterval:600,deepSleepStayAwakeSwitch:!1,deepSleepStayAwakeEntityId:"input_boolean.esphome_stay_awake",deepSleepFirmwareGuard:!1,dailyRefreshEnabled:!1,dailyRefreshTime:"08:00",noRefreshStartHour:null,noRefreshEndHour:null,renderingMode:"direct",c_include_comments:!0,oeplEntityId:"",oeplDither:2,opendisplayDeviceId:"",opendisplayEntityId:"",opendisplayDither:2,opendisplayTtl:60,glyphsets:["GF_Latin_Kernel"]},hn=50,mi={RSS:300,ENTITIES:60},fi=5e3,le=10,yi=10,gn={white:"COLOR_WHITE",black:"COLOR_BLACK",gray:"Color(160, 160, 160)",grey:"Color(160, 160, 160)",red:"COLOR_RED",green:"COLOR_GREEN",blue:"COLOR_BLUE",yellow:"COLOR_YELLOW",orange:"COLOR_ORANGE"},mn=800,fn=480;window.ESPHomeDesigner=window.ESPHomeDesigner||{version:"1.0.0-rc26",constants:{COLORS:pi,UI_DEFAULTS:ui,ALIGNMENT:gi,ORIENTATIONS:$e,DEFAULT_PREFERENCES:un,WIDGET_DEFAULTS:hi,HISTORY_LIMIT:hn,CACHE_TTL:mi,ENTITY_LIMIT:fi,ESPHOME_COLOR_MAPPING:gn,DEFAULT_CANVAS_WIDTH:mn,DEFAULT_CANVAS_HEIGHT:fn,SNAP_DISTANCE:le,GRID_SIZE:yi}};function ae(){try{const t=globalThis;return typeof t.addEventListener=="function"&&typeof t.removeEventListener=="function"?t:null}catch{return null}}function H(t,e,n){const i=ae();return i?(n===void 0?i.addEventListener(t,e):i.addEventListener(t,e,n),!0):!1}function $(t,e,n){const i=ae();return i?(i.removeEventListener(t,e),!0):!1}function xt(t){const e=ae();return e?e.dispatchEvent(t):!1}function _i(){return!!ae()?.isSecureContext}function vi(){const t=ae();return{x:t?.scrollX||0,y:t?.scrollY||0}}function Rt(){return ae()?.devicePixelRatio||1}function bi(t){const e=ae();return e?e.getComputedStyle(t):null}const xi=globalThis,Si=xi.process,Nt=ae(),wi=(typeof localStorage<"u"?localStorage.getItem("esphome-designer-debug"):Si?.env?.DEBUG||"")==="true"||!!Nt&&new URLSearchParams(Nt.location.search).get("debug")==="true",v={log:(...t)=>wi&&console.log("[ESPHomeDesigner]",...t),warn:(...t)=>console.warn("[ESPHomeDesigner]",...t),error:(...t)=>console.error("[ESPHomeDesigner]",...t)},Ei=`# ============================================================================
...
display:
  - platform: waveshare_epaper
    ...
    # __LAMBDA_PLACEHOLDER__
`,yn="esphome-designer-ha-auth";let _n=null;function St(){try{const t=globalThis.location;return t||null}catch{return null}}function Qe(){try{return globalThis.localStorage??null}catch{return null}}function vn(t){if(typeof t!="string")return;const e=t.trim();!e||e==="null"||(_n=e)}function Vi(){try{const t=globalThis.name;if(!t)return;const e=JSON.parse(t);e?.type===yn&&vn(e.accessToken)}catch{}}function qi(){Vi();try{globalThis.addEventListener?.("message",t=>{const e=St();if(e&&t.origin!==e.origin)return;const n=t.data;n?.type===yn&&vn(n.accessToken)})}catch{}}function bn(t){if(!t)return null;let e=t.trim();if(!e)return null;try{const n=new URL(e);return n.protocol!=="http:"&&n.protocol!=="https:"?null:(e=`${n.origin}${n.pathname}`,n.search&&(e+=n.search),e.endsWith("/")&&(e=e.slice(0,-1)),e.includes("reterminal_dashboard")&&(e=e.replace("reterminal_dashboard","esphome_designer")),e.includes("/api/")||(e+="/api/esphome_designer"),e)}catch{return null}}function xn(){const t=Sn();if(t){const e=bn(t);return e?(e!==t.trim()&&(v.log("[Env] Normalizing stored manual HA URL"),wn(e)),e):(v.warn("[Env] Ignoring invalid manually configured HA URL"),null)}try{const e=St();return!e||e.protocol==="file:"?null:e.hostname==="homeassistant"||e.hostname==="hassio"||e.pathname.includes("/api/")||e.pathname.includes("/local/")||e.pathname.includes("/hacsfiles/")||e.pathname.includes("/esphome-designer")?`${e.origin}/api/esphome_designer`:null}catch{return null}}function Sn(){try{const t=Qe();return t?t.getItem("ha_manual_url"):null}catch{return null}}function wn(t){try{const e=Qe();if(!e)return;if(t){const n=bn(t);if(!n){v.warn("[Env] Refusing to store invalid HA URL");return}e.setItem("ha_manual_url",n)}else e.removeItem("ha_manual_url")}catch(e){v.error("Failed to save HA URL:",e)}}function En(){try{const t=Qe();return t?t.getItem("ha_llat_token"):null}catch{return null}}function Cn(){return _n||En()}function Xi(t){try{const e=Qe();if(!e)return;t?e.setItem("ha_llat_token",t):e.removeItem("ha_llat_token")}catch(e){v.error("Failed to save HA Token:",e)}}let F=xn();qi();function Bt(){F=xn()}function W(){return!!F}function dt(){try{const t=St();return!t||t.protocol==="file:"?!1:t.hostname==="homeassistant"||t.hostname==="hassio"||t.pathname.includes("/api/esphome_designer")||t.pathname.includes("/esphome-designer")}catch{return!1}}const Ki="data-esphome-designer-panel-root",Ji="data-esphome-designer-overlay-root";function Zi(){return document.querySelector(`[${Ki}]`)||document.body}function Qi(){return document.querySelector(`[${Ji}]`)||Zi()}function X(t){return Qi().appendChild(t),t}function eo(){try{const t=globalThis.parent;return!t||t===globalThis?null:t}catch{return null}}function to(){const t=eo();if(!t)return null;try{const e=t.__ESPHOME_DESIGNER_HASS__;if(e&&typeof e.callApi=="function")return e}catch{}try{const e=t.document?.querySelector?.("esphome-designer-panel")?._hass;if(e&&typeof e.callApi=="function")return e}catch{}try{const e=t.document?.querySelector?.("home-assistant")?.hass;if(e&&typeof e.callApi=="function")return e}catch{}return null}function no(t){if(!t)return null;try{decodeURI(t);const e=new URL(t,globalThis.location?.origin||"http://localhost");let n=e.pathname;return n.startsWith("/api/")?n=n.slice(5):n=n.replace(/^\/+/,""),`${n}${e.search}`}catch{return null}}function io(t){if(!t)return{};if(t instanceof Headers){const e={};return t.forEach((n,i)=>{e[i]=n}),e}return Array.isArray(t)?Object.fromEntries(t):{...t}}function oo(t,e){if(t==null)return;if(typeof t!="string")return t;const n=io(e),i=n["Content-Type"]||n["content-type"]||"",o=t.trim();if(o){if(i.includes("application/json")||i.includes("text/plain")||o.startsWith("{")||o.startsWith("["))try{return JSON.parse(o)}catch{return t}return t}}function Wt(t,e=200){const n=typeof t=="string"?t:JSON.stringify(t);return{ok:e>=200&&e<300,status:e,json:async()=>t,text:async()=>n,blob:async()=>new Blob([n],{type:"application/json"})}}function ro(t){const e=Number(t?.statusCode??t?.status_code??t?.status);return Number.isFinite(e)&&e>0?e:500}function ao(t){const e=t,n=e?.message||"Request failed",i=e?.body;if(i&&typeof i=="object")return{message:n,...i};if(typeof i=="string")try{const o=JSON.parse(i);return{message:n,...o}}catch{return{error:i,message:n}}return{error:n,message:n}}async function so(t,e={}){const n=to(),i=no(t);if(!n||!i||typeof n.callApi!="function")return null;if(e.signal?.aborted)throw new DOMException("The operation was aborted.","AbortError");try{const o=await n.callApi((e.method||"GET").toLowerCase(),i,oo(e.body,e.headers));return Wt(o,200)}catch(o){return Wt(ao(o),ro(o))}}function O(t,e="info",n=3e3){let i=document.getElementById("toast-container");i||(i=document.createElement("div"),i.id="toast-container",i.style.position="fixed",i.style.bottom="20px",i.style.right="20px",i.style.zIndex="9999",X(i));const o=document.createElement("div");o.className="toast";const r=o.style;e==="error"?r.background="rgba(255, 0, 0, 0.8)":e==="success"?r.background="rgba(0, 128, 0, 0.8)":r.background="rgba(0,0,0,0.8)",o.textContent=t,r.color="white",r.padding="10px 20px",r.borderRadius="4px",r.marginTop="10px",r.opacity="0",r.transition="opacity 0.3s",i.appendChild(o),requestAnimationFrame(()=>{r.opacity="1"}),setTimeout(()=>{r.opacity="0",setTimeout(()=>{o.remove()},300)},n)}const lo="ai_api_key_";function wt(t){return t.startsWith(lo)}function co(t){const e={};return Object.keys(t).forEach(n=>{wt(n)||(e[n]=t[n])}),e}function Ft(){try{return globalThis.localStorage??null}catch{return null}}class po{constructor(){this.keys={ai_api_key_gemini:"",ai_api_key_openai:"",ai_api_key_openrouter:"",ai_api_key_minimax:"",ai_api_key_glm:""},this.loadFromLocalStorage()}get(e){return this.keys[e]||""}set(e,n){if(e in this.keys){const i=this.keys;i[e]=n,this.saveToLocalStorage()}}saveToLocalStorage(){try{const e=Ft();if(!e)return;const n={};Object.keys(this.keys).forEach(i=>{wt(i)&&(n[i]=this.keys[i])}),e.setItem("esphome-designer-ai-keys",JSON.stringify(n))}catch(e){v.warn("[SecretsStore] Failed to save AI keys to localStorage:",e)}}loadFromLocalStorage(){try{const e=Ft();if(!e)return;const n=e.getItem("esphome-designer-ai-keys");if(n){const i=JSON.parse(n);i&&typeof i=="object"&&(this.keys={...this.keys,...i},v.log("[SecretsStore] AI keys loaded from local storage"))}}catch(e){v.warn("[SecretsStore] Failed to load AI keys from localStorage:",e)}}}async function uo(){if(!W()){v.warn("Cannot load layout from backend: No HA backend detected.");return}try{let t=null;try{const i=await Y(`${F}/layouts`,{headers:z()});if(i.ok){const o=await i.json();v.log("[loadLayoutFromBackend] Available layouts:",o.layouts?.map(r=>r.id)),v.log(`[loadLayoutFromBackend] Last active layout ID from backend: ${o.last_active_layout_id}`),o.last_active_layout_id&&(o.layouts?.some(a=>a.id===o.last_active_layout_id)?(t=o.last_active_layout_id,v.log(`[loadLayoutFromBackend] Loading last active layout: ${t}`)):v.warn(`[loadLayoutFromBackend] Last active layout '${o.last_active_layout_id}' no longer exists`)),!t&&o.layouts&&o.layouts.length>0&&(t=o.layouts[0].id,v.log(`[loadLayoutFromBackend] No valid last active, using first layout: ${t}`))}}catch(i){v.warn("[loadLayoutFromBackend] Could not fetch layouts list:",i)}let e;if(t?e=await Y(`${F}/layouts/${t}`,{headers:z()}):e=await Y(`${F}/layout`,{headers:z()}),!e.ok)throw new Error(`Failed to load layout: ${e.status}`);const n=await e.json();!n.device_id&&t&&(n.device_id=t),v.log(`[loadLayoutFromBackend] Loaded layout '${n.device_id||t||"default"}':`,{name:n.name,device_model:n.device_model,pages:n.pages?.length,widgets:n.pages?.reduce((i,o)=>i+(o.widgets?.length||0),0),renderingMode:n.renderingMode||n.rendering_mode}),p&&(n.device_id||t)&&p.setCurrentLayoutId(n.device_id||t),typeof ue=="function"?ue(n):v.error("[loadLayoutFromBackend] loadLayoutIntoState function missing!"),I(P.LAYOUT_IMPORTED,n)}catch(t){v.error("Error loading layout from backend:",t),O("Error loading layout from backend","error",5e3)}}let nt=!1,it=!1;async function Pn(){if(!W())return!1;if(nt)return it=!0,v.log("[saveLayoutToBackend] Save already in progress, queuing..."),!1;if(!p)throw new Error("AppState not available");const t=p.currentLayoutId||"reterminal_e1001",e=p.settings.device_model||p.deviceModel||"reterminal_e1001",i={...p.getPagesPayload(),device_id:t,name:p.deviceName||"Layout 1",device_model:e,deviceName:p.deviceName||"Layout 1"};nt=!0,it=!1;try{v.log(`[saveLayoutToBackend] Saving to layout '${t}':`,{device_model:e,pages:i.pages?.length,widgets:i.pages?.reduce((s,l)=>s+(l.widgets?.length||0),0),renderingMode:i.renderingMode});const o=new AbortController,r=setTimeout(()=>o.abort(),1e4),a=await Y(`${F}/layouts/${t}`,{method:"POST",headers:z(),body:JSON.stringify(i),signal:o.signal});if(clearTimeout(r),!a.ok){const s=await a.json().catch(()=>({}));throw new Error(s.message||s.error||`Save failed: ${a.status}`)}return v.log(`[saveLayoutToBackend] Layout '${t}' saved successfully`),!0}catch(o){const r=o instanceof Error?o:new Error(String(o));if(r.name==="AbortError")return!0;if(r.message.includes("Failed to fetch")||r.message.includes("NetworkError")||r.message.includes("net::ERR_")||r.message.includes("ERR_EMPTY_RESPONSE")||r.message.includes("Load failed"))return!1;throw v.error("Failed to save layout to backend:",r),r}finally{nt=!1,it&&setTimeout(()=>{Pn().catch(()=>{})},500)}}async function ho(t){if(!W())throw new Error("No backend");const e=await Y(`${F}/import_snippet`,{method:"POST",headers:z(),body:JSON.stringify({yaml:t})});if(!e.ok){const n=await e.json().catch(()=>({}));throw new Error(n.message||n.error||`Import failed with status ${e.status}`)}return await e.json()}let Q=[],ot=!1;function z(){const t={"Content-Type":"application/json"},e=Cn();return e&&e.trim()!==""&&e!=="null"&&(t.Authorization=`Bearer ${e}`),t}async function Y(t,e={}){const n=await so(t,e);return n||fetch(t,e)}const ct="entity-datalist-global";let se=null;function In(){return se||(se=document.getElementById(ct),se||(se=document.createElement("datalist"),se.id=ct,X(se))),se}function go(t){const e=In();e.innerHTML="",!(!t||t.length===0)&&(t.forEach(n=>{const i=document.createElement("option");i.value=n.entity_id,i.label=n.name||n.entity_id,e.appendChild(i)}),v.log(`[EntityDatalist] Updated with ${t.length} entities`))}async function pe(){if(!W()||!F)return[];if(ot)return Q;ot=!0;try{const t=new AbortController,e=setTimeout(()=>t.abort(),1e4);let n,i=!1;const o=Cn();n=`${F}/entities?domains=sensor,binary_sensor,weather,light,switch,fan,cover,climate,media_player,input_number,number,input_boolean,input_text,input_select,button,input_button,calendar,person,device_tracker,sun,update,scene`,v.log("[EntityStates] Fetching from:",n);let r;try{r=await Y(n,{headers:z(),signal:t.signal})}catch(s){if(o&&F)n=`${F.replace("/api/esphome_designer","")}/api/states`,v.log("[EntityStates] Custom endpoint failed, trying native HA API:",n),i=!0,r=await Y(n,{headers:z(),signal:t.signal});else throw s}if(clearTimeout(e),!r.ok)return v.warn("[EntityStates] Failed to fetch:",r.status),[];let a=await r.json();if(i&&Array.isArray(a)){const s=["sensor","binary_sensor","weather","light","switch","fan","cover","climate","media_player","input_number","number","input_boolean","input_text","input_select","button","input_button","calendar","person","device_tracker","sun","update","scene"];a=a.filter(l=>{const c=l.entity_id?.split(".")[0];return s.includes(c)}).map(l=>({entity_id:l.entity_id,name:l.attributes?.friendly_name||l.entity_id,state:l.state,unit:l.attributes?.unit_of_measurement,attributes:l.attributes||{}}))}return Array.isArray(a)?(v.log(`[EntityStates] Received ${a.length} entities`),Q=a.map(s=>{const l=s.unit?`${s.state} ${s.unit}`:s.state;return{entity_id:s.entity_id,domain:s.entity_id?.split(".")?.[0]||"",name:s.name||s.entity_id,state:s.state,unit:s.unit,attributes:s.attributes||{},formatted:l}}),v.log(`[EntityStates] Cached ${Q.length} entity states`),p&&(p.entityStates={},Q.forEach(s=>{p.entityStates[s.entity_id]=s}),v.log(`[EntityStates] Populated AppState.entityStates with ${Object.keys(p.entityStates).length} entries`)),go(Q),I(P.ENTITIES_LOADED,Q),Q):(v.warn("[EntityStates] Invalid response format"),[])}catch(t){return t instanceof Error&&t.name==="AbortError"?v.warn("[EntityStates] Request timed out after 10 seconds"):v.warn("[EntityStates] Error fetching:",t),[]}finally{ot=!1}}function As(t){const e=Q.find(n=>n.entity_id===t);return e?e.attributes??null:null}function mo(t){if(t==null||t==="")return 24*60*60*1e3;if(typeof t=="number")return Math.max(t,0)*1e3;const e=String(t).trim();if(!e)return 24*60*60*1e3;if(/^\d+(?:\.\d+)?$/.test(e))return parseFloat(e)*1e3;const n=e.match(/^(\d+(?:\.\d+)?)([a-z]+)$/i);if(!n)return 24*60*60*1e3;const i=parseFloat(n[1]),o=n[2].toLowerCase();return o.startsWith("s")?i*1e3:o.startsWith("m")?i*60*1e3:o.startsWith("h")?i*60*60*1e3:o.startsWith("d")?i*24*60*60*1e3:o.startsWith("w")?i*7*24*60*60*1e3:i*1e3}function fo(){return(F||"").replace(/\/api\/esphome_designer$/,"")}function yo(t){return!Array.isArray(t)||t.length===0?[]:(Array.isArray(t[0])?t[0]:t).filter(n=>n&&typeof n=="object").map(n=>({state:n.state,last_changed:n.last_changed??n.last_updated??null,last_updated:n.last_updated??n.last_changed??null})).filter(n=>n.state!==void 0&&n.state!==null)}let zt=!1;async function Ds(t,e="24h"){if(!W()||!F||!t)return[];const n=fo(),i=new Date,o=new Date(i.getTime()-mo(e)),r=n?`${n}/api/history/period/${encodeURIComponent(o.toISOString())}?filter_entity_id=${encodeURIComponent(t)}&end_time=${encodeURIComponent(i.toISOString())}&minimal_response&no_attributes&significant_changes_only=0`:null;try{if(!r)return[];const a=await Y(r,{headers:z()});if(!a.ok){const s=await a.text().catch(()=>"Unknown error");return zt||(v.log(`[EntityHistory] History fetch failed for ${t}: ${s}`),zt=!0),[]}return yo(await a.json())}catch{return[]}}let kn;try{kn=Object.assign({"../../hardware/elecrow-esp32-7inch.yaml":Ei,"../../hardware/elecrow-esp32-p4-9inch-v1.2.yaml":Ci,"../../hardware/geekmagic-mini-esp8266.yaml":Pi,"../../hardware/geekmagic-pro-esp32.yaml":Ii,"../../hardware/guition-esp32-jc4827w543.yaml":ki,"../../hardware/guition-esp32-jc8048w535.yaml":Li,"../../hardware/guition-esp32-jc8048w550.yaml":Ti,"../../hardware/guition-esp32-p4-jc4880p443.yaml":Mi,"../../hardware/guition-esp32-p4-jc8012p4a1c.yaml":Oi,"../../hardware/guition-esp32-s3-4848s040.yaml":Ai,"../../hardware/lilygo-tdisplays3.yaml":Di,"../../hardware/m5stack-tab5.yaml":Gi,"../../hardware/seeedstudio-reterminal-d1001.yaml":Hi,"../../hardware/seeedstudio-sensecap-indicator.yaml":Ri,"../../hardware/sunton-esp32-2432s028.yaml":Ni,"../../hardware/sunton-esp32-2432s028R.yaml":Bi,"../../hardware/sunton-esp32-4827s032R.yaml":Wi,"../../hardware/sunton-esp32-8048s050.yaml":Fi,"../../hardware/sunton-esp32-8048s070.yaml":zi,"../../hardware/viewdisplay-esp32-s3-uedx48480021.yaml":Yi,"../../hardware/waveshare-esp32-s3-touch-lcd-4.3.yaml":$i,"../../hardware/waveshare-esp32-s3-touch-lcd-7.yaml":Ui,"../../hardware/waveshare-esp32-universal-epaper-7.5v2.yaml":ji})}catch{}function _o(t,e){const i=new RegExp(`^${e}:\\s*$`,"m").exec(t);if(!i)return"";const o=i.index,r=t.indexOf(`
`,o),a=r===-1?t.length:r+1,s=t.slice(a).search(/^(?!\s)([A-Za-z0-9_]+):/m),l=s===-1?t.length:a+s;return t.slice(o,l)}const Et={getGlob(){const t=kn;return t?()=>t:void 0},getStorage(){try{return globalThis.localStorage??null}catch{return null}}};async function vo(){if(W())try{const i=`${F}/hardware/templates`;v.log("[HardwareDiscovery] Fetching from:",i);const o=await Y(i,{headers:z(),cache:"no-store"});if(!o.ok)throw new Error(`HTTP ${o.status}`);return(await o.json()).templates||[]}catch(i){v.error("Failed to fetch dynamic hardware templates from HA:",i)}v.log("[HardwareDiscovery] Attempting to load bundled profiles via glob...");const t=[],e=Et.getGlob();if(typeof e!="function")return v.log("[HardwareDiscovery] Bundled profile glob is unavailable in this runtime; relying on backend/localStorage profiles only."),[];const n=e("../../hardware/*.yaml",{query:"?raw",import:"default",eager:!0});for(const i in n)try{const o=n[i],r=i.split("/").pop()||"hardware.yaml",a=Ln(o,r);a.id=r.replace(/\.yaml$/i,"").replace(/[^a-z0-9]/gi,"_").toLowerCase(),a.isPackageBased=!0,a.hardwarePackage=`hardware/${r}`,a.isOfflineImport=!1,t.push(a)}catch(o){v.warn(`[HardwareDiscovery] Failed to parse bundled file ${i}:`,o)}return v.log(`[HardwareDiscovery] Loaded ${t.length} bundled fallback profiles.`),t}function Ln(t,e){const n="dynamic_offline_"+e.replace(/[^a-z0-9]/gi,"_").toLowerCase();let i=e.replace(/\.yaml$/i,""),o=800,r=480,a="rect";const s=t.match(/#\s*Name:\s*(.*)/i);s&&(i=s[1].trim());const l=t.match(/#\s*Resolution:\s*(\d+)x(\d+)/i);l&&(o=parseInt(l[1]),r=parseInt(l[2]));const c=t.match(/#\s*Shape:\s*(rect|round)/i);c&&(a=c[1].toLowerCase());const u=!!t.match(/#\s*Inverted:\s*(true|yes|1)/i),h=_o(t,"display")||t,g=h.match(/^\s*-\s*platform:\s*([a-z0-9_]+)/m)||h.match(/^\s*platform:\s*([a-z0-9_]+)/m),m=g?g[1].trim():void 0,f=h.match(/^\s*model:\s*"?([^"\n]+)"?/m),_=f?f[1].trim():void 0;let y="esp32-s3",b;const S=t.match(/^\s*esp8266:/m),w=t.match(/^\s*rp2:/m);S?y="esp8266":w?y="rp2040":t.match(/^\s*esp32:/m)&&(t.toLowerCase().includes("esp32-s3")?y="esp32-s3":t.toLowerCase().includes("esp32-c3")?y="esp32-c3":t.toLowerCase().includes("esp32-c6")?y="esp32-c6":t.toLowerCase().includes("esp32p4")||t.toLowerCase().includes("esp32-p4")?y="esp32-p4":y="esp32");const E=t.match(/^\s*board:\s*([^\n]+)/m);E&&(b=E[1].trim(),w?y=b.toLowerCase().includes("pico2")||b.toLowerCase().includes("rp2350")?"rp2350":"rp2040":S||(b.toLowerCase().includes("s3")?y="esp32-s3":b.toLowerCase().includes("c3")?y="esp32-c3":b.toLowerCase().includes("c6")?y="esp32-c6":b.toLowerCase().includes("p4")&&(y="esp32-p4")));const C=t.match(/#\s*Chip:\s*(.*)/i);C&&(y=C[1].trim());const x=t.match(/#\s*Board:\s*(.*)/i);x&&(b=x[1].trim());const k=h.match(/^\s*color_palette:\s*(\S+)/m),L=k?k[1].trim():void 0,A=h.match(/^\s*color_order:\s*(\S+)/m),M=A?A[1].trim():void 0,D=h.match(/^\s*update_interval:\s*(\S+)/m),B=D?D[1].trim():void 0,J=h.match(/^\s*invert_colors:\s*(true|false)/mi),he=J?J[1].toLowerCase()==="true":void 0;return{id:n,name:i,resolution:{width:o,height:r},shape:a,chip:y,board:b,displayPlatform:m,displayModel:_,colorPalette:L,colorOrder:M,updateInterval:B,invertColors:he,isPackageBased:!0,isOfflineImport:!0,content:t,features:{psram:t.includes("psram:"),lcd:!t.includes("waveshare_epaper")&&!t.includes("epaper_spi")&&!t.includes("it8951"),lvgl:t.includes("lvgl:")||!t.includes("waveshare_epaper")&&!t.includes("epaper_spi")&&!t.includes("it8951"),epaper:t.includes("waveshare_epaper")||t.includes("epaper_spi")||t.includes("it8951"),touch:t.includes("touchscreen:"),inverted_colors:u}}}function bo(t){const e=Et.getStorage();if(!e){v.warn("No localStorage available for offline profiles.");return}try{const n=JSON.parse(e.getItem("esphome-offline-profiles")||"{}");n[t.id]=t,e.setItem("esphome-offline-profiles",JSON.stringify(n)),v.log("[HardwarePersistence] Saved offline profile to localStorage:",t.id)}catch(n){v.error("Failed to save profile to localStorage:",n)}}function xo(){const t=Et.getStorage();if(!t)return{};try{return JSON.parse(t.getItem("esphome-offline-profiles")||"{}")}catch(e){return v.warn("Could not load offline profiles from storage:",e),{}}}const G={reterminal_e1001:{name:"Seeedstudio reTerminal E1001 (Monochrome)",displayType:"binary",chip:"esp32-s3",board:"esp32-s3-devkitc-1",displayModel:"7.50inv2p",displayPlatform:"waveshare_epaper",resolution:{width:800,height:480},shape:"rect",psram_mode:"octal",pins:{display:{cs:"GPIO10",dc:"GPIO11",reset:{number:"GPIO12",inverted:!1},busy:{number:"GPIO13",inverted:!0}},i2c:{sda:"GPIO19",scl:"GPIO20"},spi:{clk:"GPIO7",mosi:"GPIO9"},batteryEnable:"GPIO21",batteryAdc:"GPIO1",buzzer:"GPIO45",buttons:{left:"GPIO5",right:"GPIO4",refresh:"GPIO3",home:"GPIO2"}},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15}},features:{psram:!0,buzzer:!0,buttons:!0,sht4x:!0,epaper:!0,inverted_colors:!0}},reterminal_e1002:{name:"Seeedstudio reTerminal E1002 (6-Color)",displayType:"color",displayModel:"Seeed-reTerminal-E1002",displayPlatform:"epaper_spi",deepSleepDisplayRefreshDelay:"35s",resolution:{width:800,height:480},shape:"rect",psram_mode:"octal",pins:{display:{cs:null,dc:null,reset:null,busy:null},i2c:{sda:"GPIO19",scl:"GPIO20"},spi:{clk:"GPIO7",mosi:"GPIO9"},batteryEnable:"GPIO21",batteryAdc:"GPIO1",buzzer:"GPIO45",buttons:{left:"GPIO5",right:"GPIO4",refresh:"GPIO3",home:"GPIO2"}},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15}},features:{psram:!0,buzzer:!0,buttons:!0,sht4x:!0,epaper:!0}},reterminal_e1003:{name:"Seeedstudio reTerminal E1003 (Monochrome)",displayType:"grayscale",chip:"esp32-s3",board:"esp32-s3-devkitc-1",displayModel:"Seeed-reTerminal-E1003",displayPlatform:"it8951",resolution:{width:1872,height:1404},shape:"rect",psram_mode:"octal",frameworkHint:"ESP-IDF (Required; ESPHome 2026.7.0+)",system_section_overrides:{esp32:["  framework:","    type: esp-idf","    sdkconfig_options:","      CONFIG_ESP32S3_DEFAULT_CPU_FREQ_240: y","      CONFIG_ESP32S3_DATA_CACHE_64KB: y"]},pins:{i2c:{sda:"GPIO19",scl:"GPIO20"},spi:{clk:"GPIO7",mosi:"GPIO9",miso:"GPIO8"},batteryEnable:"GPIO40",batteryAdc:"GPIO1",buzzer:"GPIO45",buttons:{left:"GPIO5",right:"GPIO4",refresh:"GPIO3"}},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15}},batteryEnableAlwaysOn:!0,features:{psram:!0,buzzer:!0,buttons:!0,sht4x:!0,epaper:!0,touch:!0,inverted_colors:!1},touch:{platform:"gt911",i2c_id:"bus_a",address:"0x5D",interrupt_pin:"GPIO2",reset_pin:"GPIO48"}},reterminal_e1004:{name:'Seeedstudio reTerminal E1004 13.3" (Spectra 6)',displayType:"color",chip:"esp32-s3",board:"esp32-s3-devkitc-1",displayModel:"seeed-reterminal-e1004",displayPlatform:"epaper_spi",resolution:{width:1200,height:1600},shape:"rect",psram_mode:"octal",display_config:["  - platform: epaper_spi","    model: seeed-reterminal-e1004","    cs1_pin:","      number: GPIO2","      allow_other_uses: true","    update_interval: never"],external_components:["  - source:","      type: git","      url: https://github.com/esphome/esphome","      ref: pull/16706/head","    components: [ epaper_spi ]"],system_section_overrides:{esp32:["  framework:","    type: esp-idf","    sdkconfig_options:","      CONFIG_ESP32S3_DEFAULT_CPU_FREQ_240: y","      CONFIG_ESP32S3_DATA_CACHE_64KB: y","      CONFIG_SPIRAM_MODE_OCT: y"]},pins:{display:{cs:null,dc:null,reset:null,busy:null},i2c:{sda:"GPIO19",scl:"GPIO20"},spi:{clk:"GPIO7",mosi:"GPIO9"},batteryEnable:"GPIO21",batteryAdc:"GPIO1",buzzer:"GPIO45",buttons:{left:"GPIO5",right:"GPIO4",refresh:"GPIO3",home:{number:"GPIO2",mode:"INPUT_PULLUP",inverted:!0,allow_other_uses:!0}}},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15}},features:{psram:!0,buzzer:!0,buttons:!0,sht4x:!0,epaper:!0}},trmnl_diy_esp32s3:{name:"Seeed Studio Trmnl DIY Kit (ESP32-S3)",displayType:"binary",displayModel:"7.50inv2p",displayPlatform:"waveshare_epaper",resolution:{width:800,height:480},shape:"rect",psram_mode:"octal",pins:{display:{cs:"GPIO44",dc:"GPIO10",reset:"GPIO38",busy:{number:"GPIO4",inverted:!0}},i2c:{sda:"GPIO17",scl:"GPIO18"},spi:{clk:"GPIO7",mosi:"GPIO9"},batteryEnable:"GPIO6",batteryAdc:"GPIO1",buzzer:null,buttons:{left:"GPIO2",refresh:"GPIO5"}},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15},curve:[{from:4.15,to:100},{from:3.96,to:90},{from:3.91,to:80},{from:3.85,to:70},{from:3.8,to:60},{from:3.75,to:50},{from:3.68,to:40},{from:3.58,to:30},{from:3.49,to:20},{from:3.41,to:10},{from:3.3,to:5},{from:3.27,to:0}]},features:{psram:!0,buzzer:!1,buttons:!0,sht4x:!1,epaper:!0,inverted_colors:!0}},trmnl:{name:"TRMNL (ESP32-C3)",displayType:"binary",displayModel:"7.50inv2",displayPlatform:"waveshare_epaper",resolution:{width:800,height:480},shape:"rect",pins:{display:{cs:"GPIO6",dc:"GPIO5",reset:{number:"GPIO10",inverted:!1},busy:{number:"GPIO4",inverted:!0}},i2c:{sda:"GPIO1",scl:"GPIO2"},spi:{clk:"GPIO7",mosi:"GPIO8"},batteryEnable:null,batteryAdc:"GPIO3",buzzer:null,buttons:null},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.3,max:4.15}},features:{psram:!1,buzzer:!1,buttons:!1,sht4x:!1,epaper:!0,inverted_colors:!0},chip:"esp32-c3",board:"esp32-c3-devkitm-1"},seeed_xiao_epaper_75:{name:'Seeed Xiao ESP32C3 - 7.5" E-Paper',displayType:"binary",chip:"esp32-c3",board:"seeed_xiao_esp32c3",displayModel:"7.50inv2p",displayPlatform:"waveshare_epaper",resolution:{width:800,height:480},shape:"rect",pins:{display:{cs:"GPIO3",dc:"GPIO5",reset:"GPIO2",busy:{number:"GPIO4",inverted:!0}},spi:{clk:"GPIO8",mosi:"GPIO10"}},features:{psram:!1,buzzer:!1,buttons:!1,epaper:!0,inverted_colors:!0}},raspberry_pi_pico_w_waveshare_2_13_v3:{name:'Raspberry Pi Pico W + Waveshare 2.13" V3',displayType:"binary",chip:"rp2040",board:"rpipicow",displayModel:"2.13inv3",displayPlatform:"waveshare_epaper",resolution:{width:250,height:122},rotation_offset:90,shape:"rect",supportsDeepSleep:!1,frameworkHint:"ESPHome RP2",pins:{display:{cs:"GPIO9",dc:"GPIO8",reset:"GPIO12",busy:"GPIO13"},spi:{clk:"GPIO10",mosi:"GPIO11"}},features:{psram:!1,buzzer:!1,buttons:!1,epaper:!0,inverted_colors:!0}},raspberry_pi_pico_2_w_waveshare_2_13_v3:{name:'Raspberry Pi Pico 2 W + Waveshare 2.13" V3',displayType:"binary",chip:"rp2350",board:"rpipico2w",displayModel:"2.13inv3",displayPlatform:"waveshare_epaper",resolution:{width:250,height:122},rotation_offset:90,shape:"rect",supportsDeepSleep:!1,frameworkHint:"ESPHome RP2",pins:{display:{cs:"GPIO9",dc:"GPIO8",reset:"GPIO12",busy:"GPIO13"},spi:{clk:"GPIO10",mosi:"GPIO11"}},features:{psram:!1,buzzer:!1,buttons:!1,epaper:!0,inverted_colors:!0}},esp32_s3_photopainter:{id:"esp32_s3_photopainter",name:"Waveshare PhotoPainter (6-Color)",displayType:"color",displayModel:"7.30in-f",displayPlatform:"waveshare_epaper",resolution:{width:800,height:480},shape:"rect",psram_mode:"octal",pins:{display:{cs:"GPIO9",dc:"GPIO8",reset:"GPIO12",busy:{number:"GPIO13",inverted:!0}},i2c:{sda:"GPIO47",scl:"GPIO48"},spi:{clk:"GPIO10",mosi:"GPIO11"},batteryEnable:null,batteryAdc:null,buzzer:null,buttons:{left:"GPIO0",right:"GPIO4",refresh:null}},battery:{attenuation:"0db",multiplier:1,calibration:{min:3.3,max:4.2}},features:{psram:!0,buzzer:!1,buttons:!0,sht4x:!1,axp2101:!0,manual_pmic:!0,shtc3:!0,epaper:!0},i2c_config:{scan:!1,frequency:"10kHz"}},waveshare_esp32_s3_touch_lcd_7:{name:'Waveshare Touch LCD 7 7.0" 800x480',displayType:"color",isPackageBased:!0,hardwarePackage:"hardware/waveshare-esp32-s3-touch-lcd-7.yaml",resolution:{width:800,height:480},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"gt911",transformed:!0,transform:{swap_xy:!0}}},waveshare_esp32_s3_touch_lcd_4_3:{name:'Waveshare Touch LCD 4.3 4.3" 800x480',displayType:"color",isPackageBased:!0,hardwarePackage:"hardware/waveshare-esp32-s3-touch-lcd-4.3.yaml",resolution:{width:800,height:480},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,touch:!0},touch:{platform:"gt911",transformed:!0,transform:{swap_xy:!0}}},guition_esp32_jc4832w535:{name:'Guition JC4832W535 v3 3.5" 480x320',displayType:"color",chip:"esp32-s3",displayPlatform:"qspi_dbi",displayModel:"JC4832W535",isPackageBased:!0,hardwarePackage:"hardware/guition-esp32-jc8048w535.yaml",resolution:{width:320,height:480},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"axs15231",transformed:!0,transform:{mirror_x:!0,swap_xy:!0},calibration:{x_min:14,x_max:461,y_min:12,y_max:310}}},guition_esp32_jc8048w535:{name:'Guition JC4832W535 v3 3.5" 480x320 (Legacy ID)',displayType:"color",chip:"esp32-s3",displayPlatform:"qspi_dbi",displayModel:"JC4832W535",isPackageBased:!0,isUntestedProfile:!0,hardwarePackage:"hardware/guition-esp32-jc8048w535.yaml",resolution:{width:320,height:480},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0}},m5stack_tab5:{name:"M5Stack Tab5",displayType:"color",chip:"esp32-p4",board:"esp32-p4-evboard",displayPlatform:"mipi_dsi",displayModel:"M5STACK-TAB5-V2",isPackageBased:!0,hardwarePackage:"hardware/m5stack-tab5.yaml",resolution:{width:1280,height:720},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"st7123"}},guition_esp32_p4_jc4880p443:{name:'Guition JC4880P443 4.3" 480x800',displayType:"color",chip:"esp32-p4",board:"esp32-p4-evboard",displayPlatform:"mipi_dsi",displayModel:"JC4880P443",displayId:"main_display",touchscreenId:"device_touchscreen",isPackageBased:!0,hardwarePackage:"hardware/guition-esp32-p4-jc4880p443.yaml",resolution:{width:480,height:800},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"gt911",id:"device_touchscreen"}},guition_esp32_p4_jc8012p4a1c:{name:'Guition JC8012P4A1C 10.1" 800x1280',displayType:"color",chip:"esp32-p4",board:"esp32-p4-evboard",displayPlatform:"mipi_dsi",displayModel:"JC8012P4A1",displayId:"main_display",touchscreenId:"device_touchscreen",isPackageBased:!0,hardwarePackage:"hardware/guition-esp32-p4-jc8012p4a1c.yaml",resolution:{width:800,height:1280},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"gt911",id:"device_touchscreen"}},seeedstudio_reterminal_d1001:{name:'Seeed Studio reTerminal D1001 8" 800x1280',displayType:"color",chip:"esp32-p4",board:"esp32-p4-evboard",displayPlatform:"mipi_dsi",displayModel:"SEEED-RETERMINAL-D1001",displayId:"main_display",touchscreenId:"device_touchscreen",isPackageBased:!0,isUntestedProfile:!0,hardwarePackage:"hardware/seeedstudio-reterminal-d1001.yaml",resolution:{width:800,height:1280},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"gsl3670",id:"device_touchscreen"}},elecrow_esp32_p4_9inch_v1_2:{name:'Elecrow ESP32-P4 9" HMI 1024x600 (V1.2)',displayType:"color",chip:"esp32-p4",board:"esp32-p4-evboard",displayPlatform:"mipi_dsi",displayModel:"WAVESHARE-ESP32-P4-WIFI6-TOUCH-LCD-7B",isPackageBased:!0,hardwarePackage:"hardware/elecrow-esp32-p4-9inch-v1.2.yaml",resolution:{width:1024,height:600},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"gt911"}},elecrow_esp32_7inch:{name:'Elecrow CrowPanel 7" HMI 800x480',displayType:"color",chip:"esp32-s3",board:"esp32-s3-devkitc-1",displayPlatform:"rpi_dpi_rgb",displayModel:"ELECROW-ESP32-7INCH",displayId:"my_display",touchscreenId:"my_touchscreen",isPackageBased:!0,hardwarePackage:"hardware/elecrow-esp32-7inch.yaml",resolution:{width:800,height:480},features:{psram:!0,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!0},touch:{platform:"gt911",id:"my_touchscreen"}},geekmagic_mini_esp8266:{name:"GeekMagic Mini (ESP8266)",displayType:"color",chip:"esp8266",board:"esp01_1m",displayPlatform:"mipi_spi",displayModel:"ST7789V",isPackageBased:!0,hardwarePackage:"hardware/geekmagic-mini-esp8266.yaml",resolution:{width:240,height:240},features:{psram:!1,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!1,inverted_colors:!1}},geekmagic_pro_esp32:{name:"GeekMagic Pro (ESP32)",displayType:"color",chip:"esp32",board:"esp32dev",displayPlatform:"mipi_spi",displayModel:"st7789v",isPackageBased:!0,hardwarePackage:"hardware/geekmagic-pro-esp32.yaml",resolution:{width:240,height:240},features:{psram:!1,buzzer:!1,buttons:!1,lcd:!0,lvgl:!0,touch:!1,inverted_colors:!1}},m5stack_coreink:{name:"M5Stack M5Core Ink (200x200)",displayType:"binary",displayModel:"1.54inv2",displayPlatform:"waveshare_epaper",resolution:{width:200,height:200},shape:"rect",features:{psram:!1,buzzer:!0,buttons:!0,lcd:!1,epaper:!0,inverted_colors:!0},chip:"esp32",board:"m5stack-coreink",pins:{display:{cs:"GPIO9",dc:"GPIO15",reset:"GPIO0",busy:null},i2c:{sda:"GPIO21",scl:"GPIO22"},spi:{clk:"GPIO18",mosi:"GPIO23"},batteryEnable:{number:"GPIO12",ignore_strapping_warning:!0},batteryAdc:"GPIO35",buzzer:"GPIO2",buttons:{left:{number:"GPIO39",mode:"INPUT"},right:{number:"GPIO37",mode:"INPUT"},refresh:{number:"GPIO38",mode:"INPUT"}}},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15}},i2c_config:{scan:!0}},m5stack_paper:{name:"M5Paper (540x960)",displayType:"grayscale",displayModel:"M5Paper",displayPlatform:"it8951e",resolution:{width:960,height:540},shape:"rect",chip:"esp32",board:"m5stack-paper",features:{psram:!0,buzzer:!1,buttons:!0,lcd:!1,epaper:!0,touch:!0,inverted_colors:!0,sht3xd:!0},pins:{display:{cs:"GPIO15",dc:null,reset:"GPIO23",busy:"GPIO27"},i2c:{sda:"GPIO21",scl:"GPIO22"},spi:{clk:"GPIO14",mosi:"GPIO12",miso:"GPIO13"},batteryEnable:null,batteryAdc:"GPIO35",buzzer:null,buttons:{left:{number:"GPIO39",mode:"INPUT"},right:{number:"GPIO37",mode:"INPUT"},refresh:{number:"GPIO38",mode:"INPUT"}}},m5paper:{battery_power_pin:"GPIO5",main_power_pin:"GPIO2"},battery:{attenuation:"12db",multiplier:2,calibration:{min:3.27,max:4.15}},rotation_offset:180,touch:{platform:"gt911",i2c_id:"bus_a",address:93,interrupt_pin:"GPIO36",update_interval:"never",transform:{mirror_x:!1,mirror_y:!1,swap_xy:!0},calibration:{x_min:0,x_max:960,y_min:0,y_max:540}},external_components:["  - source: github://Passific/m5paper_esphome"]},lilygo_t5_47:{id:"lilygo_t5_47",name:'Lilygo T5 4.7" E-Paper',isUntestedProfile:!0,displayType:"binary",chip:"esp32",board:"esp-wrover-kit",displayPlatform:"t547",resolution:{width:960,height:540},shape:"rect",psram_speed:"80MHz",pins:{batteryEnable:null,batteryAdc:"GPIO36",buttons:{left:{number:"GPIO39",inverted:!0,mode:"INPUT"},right:{number:"GPIO34",inverted:!0,mode:"INPUT"},refresh:{number:"GPIO35",inverted:!0,mode:"INPUT"}}},battery:{attenuation:"12db",multiplier:2},features:{psram:!0,buzzer:!1,buttons:!0,epaper:!0,inverted_colors:!0},frameworkHint:"Arduino 3.x (required by the t547 component)",system_section_overrides:{esphome:["  platformio_options:","    lib_deps:","      - https://github.com/Xinyuan-LilyGO/LilyGo-EPD47.git"],esp32:["  framework:","    type: arduino","    version: 3.3.2","  flash_size: 16MB"]},external_components:["  - source:","      type: git","      url: https://github.com/cjb0001/esphome-components","      ref: idf5-arduino3",'    components: ["t547"]']}};function Tn(t=G){return Object.entries(t).filter(([,e])=>!e.isUntestedProfile&&!e.isComingSoon&&!e.isUnavailable).map(([e])=>e)}function So(t,e){return t?{...t,...e,features:{...t.features||{},...e.features||{}}}:e}function wo(t,e){e.forEach(n=>{t[n.id]=So(t[n.id],n)})}function Eo(t,e){Object.entries(e).forEach(([n,i])=>{t[n]=i})}let Ct=Tn(G);async function He(){try{const t=await vo();v.log(`[Devices] Loaded ${t.length} hardware profiles from backend/bundle.`),wo(G,t);const e=xo(),n=Object.keys(e);n.length>0&&(v.log(`[Devices] Restoring ${n.length} offline profiles from localStorage.`),Eo(G,e)),Ct=Tn(G),I(P.DEVICE_PROFILES_UPDATED)}catch(t){v.error("Failed to load external hardware profiles:",t)}}function xe(){return"w_"+Date.now().toString(36)+Math.random().toString(36).substring(2,7)}const ge=globalThis;typeof ge.crypto<"u"&&!ge.crypto.randomUUID?Object.defineProperty(ge.crypto,"randomUUID",{value:function(){return"10000000-1000-4000-8000-100000000000".replace(/[018]/g,e=>{const n=Number(e),i=ge.crypto?.getRandomValues(new Uint8Array(1))[0]??0;return(n^(i&15)>>n/4).toString(16)})}}):typeof ge.crypto>"u"&&(ge.crypto={randomUUID:()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,t=>{const e=Math.random()*16|0;return(t==="x"?e:e&3|8).toString(16)}),getRandomValues:t=>{for(let e=0;e<t.length;e+=1)t[e]=Math.floor(Math.random()*256);return t}});function Co(t,e){let n;return function(...o){const r=()=>{clearTimeout(n),t(...o)};clearTimeout(n),n=setTimeout(r,e)}}function Ue(t){if(t!==void 0)return JSON.parse(JSON.stringify(t))}const Gs=(t,e)=>{if(!t||!e)return;const n=e.replace(/\[(\w+)\]/g,".$1").replace(/^\./,"").split(".");let i=t;for(const o of n){if(i==null)return;i=i[o]}return i};function pt(){return{id:"page_0",name:"Overview",layout:null,widgets:[]}}function Po(t){return Array.isArray(t)&&t.length>0?t:[pt()]}function Yt(t,e){return e<=0?0:Math.max(0,Math.min(t,e-1))}function Io(t){const e=t.length;let n=0;return t.forEach(i=>{const o=i.name.match(/^Page (\d+)$/);if(o){const r=parseInt(o[1],10);r>n&&(n=r)}}),{id:`page_${Date.now()}_${e}`,name:`Page ${n+1}`,widgets:[]}}function ko(t,e){const n=Ue(t);n.id=`page_${Date.now()}_${e}`,n.name=`${t.name} (Copy)`;const i=new Map;return n.widgets.forEach(o=>{const r=o.id,a=xe();o.id=a,i.set(r,a)}),n.widgets.forEach(o=>{o.parentId&&i.has(o.parentId)&&(o.parentId=i.get(o.parentId)||null)}),n}function Lo(t,e,n,i=null,o=null,r){if(n<0||n>=t.pages.length)return!1;const a=t.pages[n],s=new Set,l=[];let c=e;const d=t.widgetsById.get(e);if(d&&d.parentId){let g=d;for(;g.parentId;){const m=t.widgetsById.get(g.parentId);if(!m)break;g=m}c=g.id}const u=g=>{if(s.has(g))return;let m=null,f=null;for(const y of t.pages)if(m=y.widgets.find(b=>b.id===g)||null,m){f=y;break}if(!m||!f||f===a)return;s.add(g),l.push({widget:m,sourcePage:f}),f.widgets.filter(y=>y.parentId===g).forEach(y=>u(y.id))};if(u(c),l.length===0)return!1;l.forEach((g,m)=>{const{widget:f,sourcePage:_}=g,y=_.widgets.indexOf(f);if(y!==-1&&_.widgets.splice(y,1),m===0&&f.parentId&&!s.has(f.parentId)&&(f.parentId=null),m===0){let b=0,S=0;if(i!==null&&o!==null&&(b=i-f.x,S=o-f.y,f.x=i,f.y=o),b!==0||S!==0)for(let w=1;w<l.length;w++){const E=l[w].widget;E.x+=b,E.y+=S}}a.widgets.push(f)});const h=r(t.protocolHardware?.orientation);for(const g of s){const m=t.widgetsById.get(g);if(!m||m.parentId&&s.has(m.parentId))continue;const f=m.x,_=m.y;m.x=Math.max(0,Math.min(h.width-(m.width||50),m.x)),m.y=Math.max(0,Math.min(h.height-(m.height||50),m.y));const y=m.x-f,b=m.y-_;if(y!==0||b!==0)for(const S of s){const w=t.widgetsById.get(S);w&&w.parentId===m.id&&(w.x+=y,w.y+=b)}}return!0}class To{constructor(){this.state={pages:[],currentPageIndex:0,deviceName:"Layout 1",deviceModel:"reterminal_e1001",currentLayoutId:"reterminal_e1001",manualYamlOverride:"",customHardware:{},protocolHardware:{width:400,height:300,colorMode:"bw"},widgetsById:new Map},this.reset()}reset(){this.state.pages=[pt()],this.state.currentPageIndex=0,this.state.manualYamlOverride="",this.rebuildWidgetsIndex()}get pages(){return this.state.pages}get currentPageIndex(){return this.state.currentPageIndex}get deviceName(){return this.state.deviceName}get deviceModel(){return this.state.deviceModel}get currentLayoutId(){return this.state.currentLayoutId}get manualYamlOverride(){return this.state.manualYamlOverride||""}get protocolHardware(){return this.state.protocolHardware}get customHardware(){return this.state.customHardware}getCurrentPage(){return this.state.pages.length===0&&(this.state.pages=[pt()],this.state.currentPageIndex=0),this.state.pages[this.state.currentPageIndex]||this.state.pages[0]}getWidgetById(e){return this.state.widgetsById.get(e)}rebuildWidgetsIndex(){this.state.widgetsById.clear();for(const e of this.state.pages)for(const n of e.widgets)this.state.widgetsById.set(n.id,n)}setPages(e){this.state.pages=Po(e),this.state.currentPageIndex=Yt(this.state.currentPageIndex,this.state.pages.length),this.rebuildWidgetsIndex(),I(P.STATE_CHANGED)}setCurrentPageIndex(e,n={}){e>=0&&e<this.state.pages.length&&(this.state.currentPageIndex=e,I(P.PAGE_CHANGED,{index:e,...n}))}reorderPage(e,n){if(e<0||e>=this.state.pages.length||n<0||n>=this.state.pages.length)return;const[i]=this.state.pages.splice(e,1);this.state.pages.splice(n,0,i),this.state.currentPageIndex===e?this.state.currentPageIndex=n:e<this.state.currentPageIndex&&n>=this.state.currentPageIndex?this.state.currentPageIndex--:e>this.state.currentPageIndex&&n<=this.state.currentPageIndex&&this.state.currentPageIndex++,I(P.STATE_CHANGED),I(P.PAGE_CHANGED,{index:this.state.currentPageIndex,forceFocus:!0})}addPage(e=null){const n=Io(this.state.pages),i=e!==null?e:this.state.pages.length;return this.state.pages.splice(i,0,n),e!==null&&e<=this.state.currentPageIndex?this.state.currentPageIndex++:e===null&&(this.state.currentPageIndex=this.state.pages.length-1),this.rebuildWidgetsIndex(),I(P.STATE_CHANGED),I(P.PAGE_CHANGED,{index:this.state.currentPageIndex,forceFocus:!0}),n}deletePage(e){e<0||e>=this.state.pages.length||this.state.pages.length!==1&&(this.state.pages.splice(e,1),this.state.currentPageIndex=Yt(this.state.currentPageIndex,this.state.pages.length),this.rebuildWidgetsIndex(),I(P.STATE_CHANGED),I(P.PAGE_CHANGED,{index:this.state.currentPageIndex,forceFocus:!0}))}duplicatePage(e){if(e<0||e>=this.state.pages.length)return null;const n=this.state.pages[e],i=ko(n,this.state.pages.length),o=e+1;return this.state.pages.splice(o,0,i),this.state.currentPageIndex=o,this.rebuildWidgetsIndex(),I(P.STATE_CHANGED),I(P.PAGE_CHANGED,{index:this.state.currentPageIndex,forceFocus:!0}),i}renamePage(e,n){e<0||e>=this.state.pages.length||!n||n.trim()===""||(this.state.pages[e].name=n.trim(),I(P.STATE_CHANGED))}addWidget(e,n=null){const i=n!==null?n:this.state.currentPageIndex;(this.state.pages[i]||this.getCurrentPage()).widgets.push(e),this.state.widgetsById.set(e.id,e),I(P.STATE_CHANGED)}updateWidget(e,n){const i=this.getWidgetById(e);i&&(Object.assign(i,n),I(P.STATE_CHANGED))}deleteWidgets(e){const n=this.getCurrentPage();let i=!1;for(const o of e){const r=n.widgets.findIndex(a=>a.id===o);r!==-1&&(n.widgets.splice(r,1),this.state.widgetsById.delete(o),i=!0)}i&&I(P.STATE_CHANGED)}moveWidgetToPage(e,n,i=null,o=null){const r=s=>this.getCanvasDimensions(s);return Lo(this.state,e,n,i,o,r)?(this.rebuildWidgetsIndex(),I(P.STATE_CHANGED),!0):!1}reorderWidget(e,n,i){const o=this.state.pages[e];if(!o)return;const r=o.widgets;if(n<0||n>=r.length||i<0||i>=r.length)return;const[a]=r.splice(n,1);r.splice(i,0,a),I(P.STATE_CHANGED)}clearCurrentPage(e=!1){const n=this.getCurrentPage();if(!n)return{deleted:0,preserved:0};const i=[],o=[];return n.widgets.forEach(r=>{e&&r.locked?o.push(r):i.push(r)}),n.widgets=o,i.forEach(r=>this.state.widgetsById.delete(r.id)),i.length>0&&I(P.STATE_CHANGED),{deleted:i.length,preserved:o.length}}setDeviceSettings(e,n){e&&(this.state.deviceName=e),n&&(this.state.deviceModel=n),I(P.SETTINGS_CHANGED)}setManualYamlOverride(e,n={}){const i=typeof e=="string"?e:"";return this.state.manualYamlOverride===i?!1:(this.state.manualYamlOverride=i,n.emitStateChange!==!1&&I(P.STATE_CHANGED),!0)}clearManualYamlOverride(e={}){return this.setManualYamlOverride("",e)}getCanvasDimensions(e=$e.LANDSCAPE){const n=this.state.deviceModel||"reterminal_e1001",i=G,o=i&&i[n]?i[n]:null;let r=mn,a=fn;if(o)o.resolution&&(r=o.resolution.width,a=o.resolution.height);else if(n==="custom"&&this.state.customHardware){const s=this.state.customHardware;s.resWidth&&s.resHeight&&(r=s.resWidth,a=s.resHeight)}return e===$e.PORTRAIT||e===$e.PORTRAIT_INVERTED?{width:Math.min(r,a),height:Math.max(r,a)}:{width:Math.max(r,a),height:Math.min(r,a)}}getPagesPayload(){return{name:this.state.deviceName,pages:this.state.pages,deviceName:this.state.deviceName,deviceModel:this.state.deviceModel,currentLayoutId:this.state.currentLayoutId,manualYamlOverride:this.state.manualYamlOverride||"",manual_yaml_override:this.state.manualYamlOverride||"",customHardware:this.state.customHardware}}getCanvasShape(){const n=G[this.state.deviceModel];return n&&n.shape?n.shape:this.state.customHardware&&this.state.customHardware.shape?this.state.customHardware.shape:"rect"}}class Mo{state;historyStack;historyIndex;constructor(){this.state={selectedWidgetIds:[],clipboardWidgets:[],zoomLevel:1,panX:0,panY:0},this.historyStack=[],this.historyIndex=-1}get selectedWidgetIds(){return this.state.selectedWidgetIds}get clipboardWidgets(){return this.state.clipboardWidgets}get zoomLevel(){return this.state.zoomLevel}setZoomLevel(e){this.state.zoomLevel=Math.max(.05,Math.min(5,e)),I(P.ZOOM_CHANGED,{zoomLevel:this.state.zoomLevel})}setSelectedWidgetIds(e){this.state.selectedWidgetIds=e||[],I(P.SELECTION_CHANGED,{widgetIds:this.state.selectedWidgetIds})}selectWidget(e,n=!1){if(n){const i=e?this.state.selectedWidgetIds.indexOf(e):-1;i===-1?e&&this.state.selectedWidgetIds.push(e):this.state.selectedWidgetIds.splice(i,1)}else this.state.selectedWidgetIds=e?[e]:[];I(P.SELECTION_CHANGED,{widgetIds:this.state.selectedWidgetIds})}copyWidgets(e){this.state.clipboardWidgets=e.map(n=>Ue(n)),v.log("[EditorStore] Widgets copied to clipboard:",this.state.clipboardWidgets.length)}recordHistory(e){const n=Ue(e);if(this.historyIndex>=0){const i=this.historyStack[this.historyIndex];if(JSON.stringify(i)===JSON.stringify(n))return}this.historyIndex<this.historyStack.length-1&&(this.historyStack=this.historyStack.slice(0,this.historyIndex+1)),this.historyStack.push(n),this.historyIndex++,this.historyStack.length>hn&&(this.historyStack.shift(),this.historyIndex--),I(P.HISTORY_CHANGED,{canUndo:this.canUndo(),canRedo:this.canRedo()})}replaceHistory(e){this.historyStack=[Ue(e)],this.historyIndex=0,I(P.HISTORY_CHANGED,{canUndo:this.canUndo(),canRedo:this.canRedo()})}undo(){return this.canUndo()?(this.historyIndex--,this.historyStack[this.historyIndex]):null}redo(){return this.canRedo()?(this.historyIndex++,this.historyStack[this.historyIndex]):null}canUndo(){return this.historyIndex>0}canRedo(){return this.historyIndex<this.historyStack.length-1}}class Oo{constructor(){this.state={...un}}get snapEnabled(){return this.state.snapEnabled}get showGrid(){return this.state.showGrid}get showDebugGrid(){return!!this.state.showDebugGrid}get showRulers(){return!!this.state.showRulers}get autoSaveEnabled(){return this.state.autoSaveEnabled!==!1}get gridOpacity(){return this.state.gridOpacity}get editor_light_mode(){return this.state.editor_light_mode}update(e){this.state={...this.state,...e},I(P.SETTINGS_CHANGED,this.state),v.log("[PreferencesStore] Settings updated")}setSnapEnabled(e){this.state.snapEnabled=e,I(P.SETTINGS_CHANGED,{snapEnabled:e})}setShowGrid(e){this.state.showGrid=e,I(P.SETTINGS_CHANGED,{showGrid:e})}setShowDebugGrid(e){this.state.showDebugGrid=e,I(P.SETTINGS_CHANGED,{showDebugGrid:e})}setShowRulers(e){this.state.showRulers=e,I(P.SETTINGS_CHANGED,{showRulers:e})}setAutoSaveEnabled(e){this.state.autoSaveEnabled=e,I(P.SETTINGS_CHANGED,{autoSaveEnabled:e})}}class Ao{constructor(e){this.app=e}selectWidget(e,n=!1){if(!e){this.app.editor.selectWidget(null,n);return}const i=this.app.getWidgetById(e);if(i)if(i.type==="group"){const s=(this.app.getCurrentPage().widgets||[]).filter(c=>c.parentId===e).map(c=>c.id),l=[e,...s];if(n)if(l.some(d=>this.app.editor.selectedWidgetIds.includes(d))){const d=new Set(l),u=this.app.editor.selectedWidgetIds.filter(h=>!d.has(h));this.app.editor.setSelectedWidgetIds(u)}else this.app.editor.setSelectedWidgetIds([...new Set([...this.app.editor.selectedWidgetIds,...l])]);else this.app.editor.setSelectedWidgetIds(l)}else this.app.editor.selectWidget(e,n)}selectWidgets(e){this.app.editor.setSelectedWidgetIds(e)}selectAllWidgets(){const e=this.app.getCurrentPage();if(!e||!e.widgets)return;const i=e.widgets.map(o=>o.id);this.selectWidgets(i)}deselectAll(){this.app.editor.setSelectedWidgetIds([])}toggleSelection(e){this.selectWidget(e,!0)}isWidgetSelected(e){return this.app.editor.selectedWidgetIds.includes(e)}groupSelection(){const e=this.app.editor.selectedWidgetIds,n=this.app.getSelectedWidgets(),i=n.some(d=>d.type==="group"||d.parentId);if(e.length<2||i)return;let o=1/0,r=1/0,a=-1/0,s=-1/0;n.forEach(d=>{o=Math.min(o,d.x),r=Math.min(r,d.y),a=Math.max(a,d.x+(d.width||0)),s=Math.max(s,d.y+(d.height||0))});const l="group_"+xe(),c={id:l,type:"group",title:"Group",x:o,y:r,width:a-o,height:s-r,props:{},expanded:!0};this.app.project.addWidget(c),n.forEach(d=>{this.app.project.updateWidget(d.id,{parentId:l})}),this.selectWidget(l),this.app.syncWidgetOrderWithHierarchy(),this.app.recordHistory(),I(P.STATE_CHANGED)}ungroupSelection(e=null){const n=this.app;let i=[];if(e)i=Array.isArray(e)?e:[e];else{const l=n.getSelectedWidgets(),c=new Set;l.forEach(d=>{d.type==="group"?c.add(d.id):d.parentId&&c.add(d.parentId)}),i=[...c]}const o=new Set;i.forEach(l=>{const c=n.getWidgetById(l);c&&(c.type==="group"?o.add(c.id):c.parentId&&o.add(c.parentId))});const r=[...o];if(r.length===0)return;const a=[];r.forEach(l=>{const c=n.getWidgetById(l);if(!c||c.type!=="group")return;(n.getCurrentPage().widgets||[]).filter(g=>g.parentId===l).forEach(g=>{this.app.project.updateWidget(g.id,{parentId:null}),a.push(g.id)})}),this.app.project.deleteWidgets(r);const s=n.getCurrentPage();if(s&&s.widgets){const l=s.widgets;s.widgets=l.filter(c=>!r.includes(c.id))}a.length>0&&this.selectWidgets(a),n.syncWidgetOrderWithHierarchy(),n.recordHistory(),I(P.STATE_CHANGED)}alignSelectedWidgets(e){const n=this.app.getSelectedWidgets();if(n.length<2)return;let i;switch(e){case"left":i=Math.min(...n.map(o=>o.x)),n.forEach(o=>this.app.project.updateWidget(o.id,{x:i}));break;case"center":{const o=Math.min(...n.map(a=>a.x)),r=Math.max(...n.map(a=>a.x+(a.width||0)));i=o+(r-o)/2,n.forEach(a=>this.app.project.updateWidget(a.id,{x:i-(a.width||0)/2}));break}case"right":i=Math.max(...n.map(o=>o.x+(o.width||0))),n.forEach(o=>this.app.project.updateWidget(o.id,{x:i-(o.width||0)}));break;case"top":i=Math.min(...n.map(o=>o.y)),n.forEach(o=>this.app.project.updateWidget(o.id,{y:i}));break;case"middle":{const o=Math.min(...n.map(a=>a.y)),r=Math.max(...n.map(a=>a.y+(a.height||0)));i=o+(r-o)/2,n.forEach(a=>this.app.project.updateWidget(a.id,{y:i-(a.height||0)/2}));break}case"bottom":i=Math.max(...n.map(o=>o.y+(o.height||0))),n.forEach(o=>this.app.project.updateWidget(o.id,{y:i-(o.height||0)}));break}this.app.recordHistory(),I(P.STATE_CHANGED)}distributeSelectedWidgets(e){const n=this.app.getSelectedWidgets();if(!(n.length<3)){if(e==="horizontal"){const i=[...n].sort((d,u)=>d.x-u.x),o=i[0],a=i[i.length-1].x-(o.x+(o.width||0)),s=i.slice(1,-1).reduce((d,u)=>d+(u.width||0),0),l=(a-s)/(i.length-1);let c=o.x+(o.width||0)+l;for(let d=1;d<i.length-1;d++)this.app.project.updateWidget(i[d].id,{x:c}),c+=(i[d].width||0)+l}else{const i=[...n].sort((d,u)=>d.y-u.y),o=i[0],a=i[i.length-1].y-(o.y+(o.height||0)),s=i.slice(1,-1).reduce((d,u)=>d+(u.height||0),0),l=(a-s)/(i.length-1);let c=o.y+(o.height||0)+l;for(let d=1;d<i.length-1;d++)this.app.project.updateWidget(i[d].id,{y:c}),c+=(i[d].height||0)+l}this.app.recordHistory(),I(P.STATE_CHANGED)}}}class Do{constructor(e){this.app=e}recordHistory(){this.app._isRestoringHistory||this.app.editor.recordHistory({pages:this.app.project.pages,deviceName:this.app.project.deviceName})}replaceHistoryBaseline(){this.app.editor.replaceHistory({pages:this.app.project.pages,deviceName:this.app.project.deviceName})}undo(){const e=this.app.editor.undo();e&&(this.app.setInternalFlag("_isRestoringHistory",!0),this.restoreSnapshot(e),setTimeout(()=>{this.app.setInternalFlag("_isRestoringHistory",!1)},0))}redo(){const e=this.app.editor.redo();e&&(this.app.setInternalFlag("_isRestoringHistory",!0),this.restoreSnapshot(e),setTimeout(()=>{this.app.setInternalFlag("_isRestoringHistory",!1)},0))}restoreSnapshot(e){this.app.project.state.pages=JSON.parse(JSON.stringify(e.pages)),this.app.project.state.deviceName=e.deviceName,this.app.project.rebuildWidgetsIndex(),I(P.STATE_CHANGED)}canUndo(){return this.app.editor.canUndo()}canRedo(){return this.app.editor.canRedo()}}let ut={};try{ut=Object.assign({"../../features/battery_icon/plugin.js":()=>T(()=>import("./plugin-CZUSM5PU.js"),__vite__mapDeps([0,1,2]),import.meta.url),"../../features/calendar/plugin.js":()=>T(()=>import("./plugin-Disn2X9z.js"),__vite__mapDeps([3,1,2]),import.meta.url),"../../features/datetime/plugin.js":()=>T(()=>import("./plugin-B_ZV41ek.js"),__vite__mapDeps([4,2,1]),import.meta.url),"../../features/debug_grid/plugin.js":()=>T(()=>import("./plugin-Bz96grI8.js"),[],import.meta.url),"../../features/energy_widget/plugin.js":()=>T(()=>import("./plugin-CP6dZvV0.js"),__vite__mapDeps([5,1,2]),import.meta.url),"../../features/graph/plugin.js":()=>T(()=>import("./plugin-Cx1qSmIb.js"),__vite__mapDeps([6,2,1]),import.meta.url),"../../features/icon/plugin.js":()=>T(()=>import("./plugin-BFOC_hck.js"),__vite__mapDeps([7,8,9,1,2]),import.meta.url),"../../features/image/plugin.js":()=>T(()=>import("./plugin-DKLjCAlv.js"),__vite__mapDeps([10,1,2]),import.meta.url),"../../features/line/plugin.js":()=>T(()=>import("./plugin-DPpv4k9S.js"),[],import.meta.url),"../../features/lvgl_arc/plugin.js":()=>T(()=>import("./plugin-BIQagZfS.js"),__vite__mapDeps([11,1,2]),import.meta.url),"../../features/lvgl_bar/plugin.js":()=>T(()=>import("./plugin-C3TaJghq.js"),[],import.meta.url),"../../features/lvgl_button/plugin.js":()=>T(()=>import("./plugin-CINDJMa3.js"),__vite__mapDeps([12,2,1]),import.meta.url),"../../features/lvgl_buttonmatrix/plugin.js":()=>T(()=>import("./plugin-BYUEJW46.js"),[],import.meta.url),"../../features/lvgl_chart/plugin.js":()=>T(()=>import("./plugin-uULqxqmr.js"),[],import.meta.url),"../../features/lvgl_checkbox/plugin.js":()=>T(()=>import("./plugin-DIexz7Kc.js"),__vite__mapDeps([13,2,1]),import.meta.url),"../../features/lvgl_dropdown/plugin.js":()=>T(()=>import("./plugin-DKvu6nsr.js"),[],import.meta.url),"../../features/lvgl_img/plugin.js":()=>T(()=>import("./plugin-CJupQF3Y.js"),[],import.meta.url),"../../features/lvgl_keyboard/plugin.js":()=>T(()=>import("./plugin-5CX7J5Ir.js"),[],import.meta.url),"../../features/lvgl_label/plugin.js":()=>T(()=>import("./plugin-CzsdLprx.js"),__vite__mapDeps([14,1,2]),import.meta.url),"../../features/lvgl_led/plugin.js":()=>T(()=>import("./plugin-CvW9GRcJ.js"),[],import.meta.url),"../../features/lvgl_line/plugin.js":()=>T(()=>import("./plugin-DavNvZJ0.js"),[],import.meta.url),"../../features/lvgl_meter/plugin.js":()=>T(()=>import("./plugin-03wdAHv5.js"),[],import.meta.url),"../../features/lvgl_obj/plugin.js":()=>T(()=>import("./plugin-Cvfrg4uG.js"),[],import.meta.url),"../../features/lvgl_qrcode/plugin.js":()=>T(()=>import("./plugin-BZNoAt0h.js"),[],import.meta.url),"../../features/lvgl_roller/plugin.js":()=>T(()=>import("./plugin-H8_Cedxq.js"),[],import.meta.url),"../../features/lvgl_slider/plugin.js":()=>T(()=>import("./plugin-BPIBweRx.js"),[],import.meta.url),"../../features/lvgl_spinbox/plugin.js":()=>T(()=>import("./plugin-CCSLU7VJ.js"),[],import.meta.url),"../../features/lvgl_spinner/plugin.js":()=>T(()=>import("./plugin-yr1brk0v.js"),[],import.meta.url),"../../features/lvgl_switch/plugin.js":()=>T(()=>import("./plugin-D_AfduZE.js"),__vite__mapDeps([15,2,1]),import.meta.url),"../../features/lvgl_tabview/plugin.js":()=>T(()=>import("./plugin-fSaSlNq3.js"),[],import.meta.url),"../../features/lvgl_textarea/plugin.js":()=>T(()=>import("./plugin-Dft6HFQs.js"),[],import.meta.url),"../../features/lvgl_tileview/plugin.js":()=>T(()=>import("./plugin-CIe8d1NL.js"),[],import.meta.url),"../../features/moon_phase/plugin.js":()=>T(()=>import("./plugin-CTHmnWFz.js"),__vite__mapDeps([16,2,1]),import.meta.url),"../../features/odp_arc/plugin.js":()=>T(()=>import("./plugin-fLOMRvii.js"),[],import.meta.url),"../../features/odp_ellipse/plugin.js":()=>T(()=>import("./plugin-FRwyy2yN.js"),[],import.meta.url),"../../features/odp_icon_sequence/plugin.js":()=>T(()=>import("./plugin-CciJdC0y.js"),[],import.meta.url),"../../features/odp_multiline/plugin.js":()=>T(()=>import("./plugin-C4VhGPFM.js"),[],import.meta.url),"../../features/odp_plot/plugin.js":()=>T(()=>import("./plugin-B97TN5cD.js"),[],import.meta.url),"../../features/odp_polygon/plugin.js":()=>T(()=>import("./plugin-C_hkq-qm.js"),[],import.meta.url),"../../features/odp_rectangle_pattern/plugin.js":()=>T(()=>import("./plugin-BMFaRNdP.js"),[],import.meta.url),"../../features/ondevice_humidity/plugin.js":()=>T(()=>import("./plugin-DoThr8QU.js"),__vite__mapDeps([17,1,2]),import.meta.url),"../../features/ondevice_temperature/plugin.js":()=>T(()=>import("./plugin-6toyWDvZ.js"),__vite__mapDeps([18,1,2]),import.meta.url),"../../features/online_image/plugin.js":()=>T(()=>import("./plugin-BkAUpZV9.js"),__vite__mapDeps([19,1,2]),import.meta.url),"../../features/progress_bar/plugin.js":()=>T(()=>import("./plugin-B8VbK5dX.js"),__vite__mapDeps([20,21,1,2]),import.meta.url),"../../features/qr_code/plugin.js":()=>T(()=>import("./plugin-UP2KZLdm.js"),__vite__mapDeps([22,1,2]),import.meta.url),"../../features/quote_rss/plugin.js":()=>T(()=>import("./plugin-DpCISaL3.js"),__vite__mapDeps([23,2,1]),import.meta.url),"../../features/rounded_rect/plugin.js":()=>T(()=>import("./plugin-YtesyQcr.js"),__vite__mapDeps([24,25,1,2]),import.meta.url),"../../features/sensor_text/plugin.js":()=>T(()=>import("./plugin-BEpM-68d.js"),__vite__mapDeps([26,9,21,2,1]),import.meta.url),"../../features/shape_circle/plugin.js":()=>T(()=>import("./plugin-DkYQT7Pj.js"),__vite__mapDeps([27,25,1,2]),import.meta.url),"../../features/shape_rect/plugin.js":()=>T(()=>import("./plugin-BJQWWSpp.js"),__vite__mapDeps([28,25,1,2]),import.meta.url),"../../features/sun_times/plugin.js":()=>T(()=>import("./plugin-Na6MDPl9.js"),__vite__mapDeps([29,2,1]),import.meta.url),"../../features/template_nav_bar/plugin.js":()=>T(()=>import("./plugin-DhaDK0W9.js"),__vite__mapDeps([30,2,1]),import.meta.url),"../../features/template_sensor_bar/plugin.js":()=>T(()=>import("./plugin-CueK5FGE.js"),__vite__mapDeps([31,1,2]),import.meta.url),"../../features/text/plugin.js":()=>T(()=>import("./plugin-7mK5DIiS.js"),__vite__mapDeps([32,9,2,1]),import.meta.url),"../../features/touch_area/plugin.js":()=>T(()=>import("./plugin-1mDNoZbi.js"),__vite__mapDeps([33,2,1,8]),import.meta.url),"../../features/weather_forecast/plugin.js":()=>T(()=>import("./plugin-C5PIVSXT.js"),__vite__mapDeps([34,35,1,2]),import.meta.url),"../../features/weather_icon/plugin.js":()=>T(()=>import("./plugin-utaFEZPt.js"),__vite__mapDeps([36,2,1,35]),import.meta.url),"../../features/wifi_signal/plugin.js":()=>T(()=>import("./plugin-C-3D7rUt.js"),__vite__mapDeps([37,1,2]),import.meta.url)})}catch{}class Go{constructor(){this.plugins=new Map,this.loading=new Map,this.aliases={label:"text",rectangle:"shape_rect",rrect:"rounded_rect",circle:"shape_circle",nav_next_page:"touch_area",nav_previous_page:"touch_area",nav_reload_page:"touch_area",puppet:"online_image",multiline:"odp_multiline",rectangle_pattern:"odp_rectangle_pattern",polygon:"odp_polygon",ellipse:"odp_ellipse",icon_sequence:"odp_icon_sequence",weather_forcast:"weather_forecast",odp_debug_grid:"debug_grid",lv_chart:"lvgl_chart"}}register(e){if(!e?.id){v.warn("[Registry] Invalid plugin registration attempt:",e);return}const n=e.id,i=this.plugins.get(n);this.plugins.set(n,{...i||{},...e}),v.log(`[Registry] Registered: ${n}`)}get(e){const n=this.aliases[e]||e;return this.plugins.get(n)}getAll(){return Array.from(this.plugins.values())}async load(e){const n=this.aliases[e]||e;if(n==="group")return null;const i=this.plugins.get(n);if(i)return i;const o=this.loading.get(n);if(o)return o;const r=(async()=>{try{const a=`../../features/${n}/plugin.js`,s=ut[a]?await ut[a]():await import(a);let l;return s.default?l=s.default:l={id:n,...s},this.register(l),this.plugins.get(n)??null}catch(a){return v.error(`[Registry] Failed to load plugin "${n}" from ESM:`,a),null}finally{this.loading.delete(n)}})();return this.loading.set(n,r),r}runHook(e,n){this.getAll().forEach(i=>{const o=e==="onCollectRequirements"?i.collectRequirements:i[e];typeof o=="function"&&o.call(i,n)})}onExportGlobals(e){this.runHook("onExportGlobals",e)}onExportEsphome(e){this.runHook("onExportEsphome",e)}onExportNumericSensors(e){this.runHook("onExportNumericSensors",e)}onExportTextSensors(e){this.runHook("onExportTextSensors",e)}onExportBinarySensors(e){this.runHook("onExportBinarySensors",e)}onExportHelpers(e){this.runHook("onExportHelpers",e)}onExportComponents(e){this.runHook("onExportComponents",e)}onCollectRequirements(e){this.runHook("onCollectRequirements",e)}}const q=new Go;v.log("[Registry] Modular system ready.");class Ho{constructor(e){this.app=e}normalizeWidgetIds(e){return e?Array.isArray(e)?e:[...e]:[]}setCustomHardware(e){this.app.project.state.customHardware=e,I(P.STATE_CHANGED),I(P.PAGE_CHANGED,{index:this.app.currentPageIndex,forceFocus:!0})}addWidget(e,n=null){this.checkRenderingModeForWidget(e),this.app.project.addWidget(e,n),this.app.recordHistory(),this.app.selectWidget(e.id),I(P.STATE_CHANGED)}updateWidget(e,n){const i=this.app,o=i.getWidgetById(e),r=this.sanitizeParentUpdate(o,n);if(this.app.project.updateWidget(e,r),o&&o.type==="group"){const a=["locked","hidden"],s={},l=r||{};if(a.forEach(c=>{l[c]!==void 0&&(s[c]=l[c])}),Object.keys(s).length>0){const c=i.pages[i.currentPageIndex];c&&c.widgets&&c.widgets.filter(u=>u.parentId===e).forEach(u=>this.updateWidget(u.id,s))}}r.parentId!==void 0&&this.syncWidgetOrderWithHierarchy(),I(P.STATE_CHANGED)}sanitizeParentUpdate(e,n){if(!n||n.parentId===void 0||!e)return n;let i=n.parentId||null;if(e.type==="group"||i===e.id)i=null;else if(i){const o=this.app.getWidgetById(i);(!o||o.type!=="group")&&(i=null)}return i===n.parentId?n:{...n,parentId:i}}updateWidgets(e,n){e.forEach(i=>this.app.project.updateWidget(i,n)),I(P.STATE_CHANGED)}updateWidgetsProps(e,n){const i=[],o=n.radius??n.border_radius??n.corner_radius;e.forEach(r=>{const a=this.app.getWidgetById(r);if(a){const s={...a.props||{},...n};if(this.app.project.updateWidget(r,{props:s}),o!==void 0&&a.parentId){const l=this.app.getWidgetById(a.parentId);if(l&&l.type==="group"&&l.title&&l.title.endsWith("Group")){const d=(this.app.getCurrentPage()?.widgets.filter(u=>u.parentId===l.id)||[]).find(u=>u.id!==a.id&&u.props?.name&&u.props.name.endsWith("Shadow"));d&&i.push({id:d.id,props:{...d.props||{},radius:o}})}}}}),i.forEach(r=>{this.app.project.updateWidget(r.id,{props:r.props})}),I(P.STATE_CHANGED)}deleteWidget(e){const n=e?[e]:this.normalizeWidgetIds(this.app.editor.selectedWidgetIds),i=[...n];n.forEach(o=>{const r=this.app.getWidgetById(o);r&&r.type==="group"&&this.app.pages[this.app.currentPageIndex].widgets.filter(s=>s.parentId===o).forEach(s=>i.push(s.id))}),this.app.project.deleteWidgets([...new Set(i)]),this.app.editor.setSelectedWidgetIds([]),this.app.recordHistory(),I(P.STATE_CHANGED)}moveWidgetToPage(e,n,i=null,o=null){const r=this.app.getWidgetById(e);if(!r)return!1;const a=this.app.getCurrentPage(),s=this.app.pages[n];if(!a||!s)return!1;const l=[r];if(r.type==="group"){const h=a.widgets.filter(g=>g.parentId===e);l.push(...h)}const c=i!==null?i-r.x:0,d=o!==null?o-r.y:0,u=new Set(l.map(h=>h.id));return a.widgets=a.widgets.filter(h=>!u.has(h.id)),l.forEach(h=>{const g=JSON.parse(JSON.stringify(h));h.id===e?(i!==null&&(g.x=i),o!==null&&(g.y=o)):(g.x+=c,g.y+=d),s.widgets.push(g)}),this.app.project.rebuildWidgetsIndex(),this.app.recordHistory(),I(P.STATE_CHANGED),!0}copyWidget(e){const i=(e?[e]:this.normalizeWidgetIds(this.app.editor.selectedWidgetIds)).map(o=>this.app.getWidgetById(o)).filter(o=>!!o);i.length>0&&this.app.editor.copyWidgets(i)}pasteWidget(){const e=this.app.editor,n=e.clipboardWidgets;if(!n||n.length===0)return;const i=n.map(o=>{const r=JSON.parse(JSON.stringify(o));return r.id=xe(),r.x+=10,r.y+=10,r});i.forEach(o=>{this.checkRenderingModeForWidget(o),this.app.project.addWidget(o)}),e.setSelectedWidgetIds(i.map(o=>o.id)),this.app.recordHistory(),I(P.STATE_CHANGED)}createDropShadow(e){const n=Array.isArray(e)?e:[e];if(n.length===0)return;const i=this.app.project.getCurrentPage();if(!i||!i.widgets)return;const o=i?i.dark_mode:void 0;let r=!1;o==="dark"?r=!0:o==="light"?r=!1:r=!!this.app.settings.dark_mode;const a=u=>{if(typeof u!="string")return!1;const h=u.trim().toLowerCase();return h===""||h==="transparent"||h==="transp"},s=(...u)=>u.find(h=>typeof h=="string"&&!a(h)),l=r?"white":"black",c="white",d=[];n.forEach(u=>{const h=this.app.getWidgetById(u);if(!h)return;const g=parseInt(h.props?.border_radius||h.props?.radius||h.props?.corner_radius||0,10);let m="shape_rect";h.type==="shape_circle"||h.type==="circle"?m="shape_circle":g>0&&(m="rounded_rect");const f={id:xe(),type:m,x:(h.x||0)+5,y:(h.y||0)+5,width:h.width,height:h.height,props:{name:(h.props?.name||h.type)+" Shadow",bg_color:l,border_color:l}};m==="rounded_rect"&&(f.props.radius=g),this.app.project.addWidget(f),h.props||(h.props={});const _=["shape_rect","rounded_rect","shape_circle","rectangle","rrect","circle"].includes(h.type),S=(_&&(s(h.props.bg_color,h.props.color)||h.props.fill)?s(h.props.bg_color,h.props.color):null)??s(h.props.bg_color,h.props.background_color)??c;_?(h.props.bg_color=S,delete h.props.background_color,delete h.props.fill):(h.props.fill=!0,(h.props.bg_color!==void 0||h.props.background_color===void 0)&&(h.props.bg_color=S),h.props.background_color!==void 0&&(h.props.background_color=S)),this.app.project.updateWidget(u,{props:{...h.props}});const w=i.widgets.findIndex(D=>D.id===u),E=i.widgets.findIndex(D=>D.id===f.id);w!==-1&&E!==-1&&this.app.project.reorderWidget(this.app.project.currentPageIndex,E,w);const C="group_"+xe(),x=Math.min(h.x,f.x),k=Math.min(h.y,f.y),L=Math.max(h.x+h.width,f.x+f.width),A=Math.max(h.y+h.height,f.y+f.height),M={id:C,type:"group",title:h.props?.name?`${h.props.name} Group`:"Shadow Group",x,y:k,width:L-x,height:A-k,props:{},expanded:!0};this.app.project.addWidget(M),this.app.project.updateWidget(f.id,{parentId:C}),this.app.project.updateWidget(h.id,{parentId:C}),d.push(C)}),d.length>0&&this.app.selectWidgets(d),this.syncWidgetOrderWithHierarchy(),this.app.recordHistory(),I(P.STATE_CHANGED)}syncWidgetOrderWithHierarchy(){const e=this.app.getCurrentPage();if(!e||!e.widgets)return;const n=[...e.widgets],i=n.filter(s=>s.type==="group"||!s.parentId),o=new Map;n.forEach(s=>{if(s.parentId&&s.type!=="group"){o.has(s.parentId)||o.set(s.parentId,[]);const l=o.get(s.parentId);l&&l.push(s)}});const r=[],a=s=>{r.push(s);const l=o.get(s.id);l&&(l.sort((c,d)=>n.indexOf(c)-n.indexOf(d)),l.forEach(a))};i.forEach(a),e.widgets=r,this.app.project.rebuildWidgetsIndex()}syncWidgetVisibilityWithMode(){const e=this.app.preferences.state.renderingMode||"direct";v.log(`[AppState] Syncing widget visibility for mode: ${e}`);let n=0;this.app.project.pages.forEach(i=>{i.widgets.forEach(o=>{const r=this.isWidgetCompatibleWithMode(o,e);!r&&!o.hidden?(o.hidden=!0,n++):r&&o.hidden&&(o.hidden=!1,n++)})}),n>0&&(v.log(`[AppState] Updated ${n} widgets due to mode switch.`),this.app.project.rebuildWidgetsIndex(),I(P.STATE_CHANGED))}isWidgetCompatibleWithMode(e,n){const i=q.get(e.type);if(!i)return!0;if(n==="oepl")return!!i.exportOEPL;if(n==="opendisplay")return!!i.exportOpenDisplay;if(n==="lvgl"){const o=e.type&&e.type.startsWith("lvgl_"),r=typeof i.exportLVGL=="function";return o||r}if(n==="direct"||n==="c"){const o=e.type&&(e.type.startsWith("lvgl_")||e.type.startsWith("oepl_"));return!!i.export&&!o}return!0}checkRenderingModeForWidget(e){if(!e||!e.type)return;const n=this.app.preferences.state.renderingMode||"direct",i=e.type.startsWith("lvgl_"),o=e.type.startsWith("oepl_"),r=e.type.startsWith("odp_")||e.type.startsWith("opendisplay_");i&&n==="direct"?(this.app.updateSettings({renderingMode:"lvgl"}),v.log(`[AppState] Auto-switched to LVGL rendering mode because an LVGL widget (${e.type}) was added.`),O("Auto-switched to LVGL rendering mode","info")):o&&n!=="oepl"?(this.app.updateSettings({renderingMode:"oepl"}),v.log(`[AppState] Auto-switched to OEPL rendering mode because an OEPL widget (${e.type}) was added.`),O("Auto-switched to OEPL mode","info")):r&&n!=="opendisplay"&&(this.app.updateSettings({renderingMode:"opendisplay"}),v.log(`[AppState] Auto-switched to OpenDisplay (ODP) mode because an ODP widget (${e.type}) was added.`),O("Auto-switched to ODP mode","info"))}}class Ro{constructor(e){this.app=e}reorderWidget(e,n,i){this.app.project.reorderWidget(e,n,i),this.app.widgetManager.syncWidgetOrderWithHierarchy(),this.app.recordHistory(),I(P.STATE_CHANGED)}setCurrentPageIndex(e,n={}){this.app.project.setCurrentPageIndex(e,n),this.app.editor.setSelectedWidgetIds([]),I(P.STATE_CHANGED)}reorderPage(e,n){this.app.project.reorderPage(e,n),this.app.recordHistory()}addPage(e=null){const n=this.app.project.addPage(e);return this.app.recordHistory(),n}deletePage(e){this.app.project.deletePage(e),this.app.recordHistory()}duplicatePage(e){const n=this.app.project.duplicatePage(e);return this.app.recordHistory(),n}renamePage(e,n){this.app.project.renamePage(e,n),this.app.recordHistory()}clearCurrentPage(e=!1){const n=this.app.project.clearCurrentPage(e);return n.deleted>0&&(this.app.editor.setSelectedWidgetIds([]),this.app.recordHistory(),I(P.STATE_CHANGED)),n}}class No{project;editor;preferences;secrets;selectionManager;historyManager;widgetManager;pageManager;_isRestoringHistory;isUndoRedoInProgress;entityStates;$raw;constructor(){this.project=new To,this.editor=new Mo,this.preferences=new Oo,this.secrets=new po,this.selectionManager=new Ao(this),this.historyManager=new Do(this),this.widgetManager=new Ho(this),this.pageManager=new Ro(this),this._isRestoringHistory=!1,this.isUndoRedoInProgress=!1,this.entityStates={},this.recordHistory(),N(P.SETTINGS_CHANGED,e=>{e&&e.renderingMode!==void 0&&this.syncWidgetVisibilityWithMode()})}reset(){this.project.reset(),this.editor.state.selectedWidgetIds=[],this.recordHistory()}get pages(){return this.project.pages}get state(){return this.project.state}get currentPageIndex(){return this.project.currentPageIndex}get selectedWidgetId(){return this.editor.selectedWidgetIds[0]||null}get selectedWidgetIds(){return this.editor.selectedWidgetIds}get settings(){return{...this.preferences.state,device_name:this.project.deviceName,deviceName:this.project.deviceName,device_model:this.project.deviceModel,deviceModel:this.project.deviceModel,customHardware:this.project.customHardware,custom_hardware:this.project.customHardware,protocolHardware:this.project.protocolHardware,protocol_hardware:this.project.protocolHardware,...this.secrets.keys}}get deviceName(){return this.project.deviceName}get deviceModel(){return this.project.deviceModel}get currentLayoutId(){return this.project.currentLayoutId}get manualYamlOverride(){return this.project.manualYamlOverride}get snapEnabled(){return this.preferences.snapEnabled}get showGrid(){return this.preferences.showGrid}get showDebugGrid(){return this.preferences.showDebugGrid}get showRulers(){return this.preferences.showRulers}get zoomLevel(){return this.editor.zoomLevel}getCurrentPage(){return this.project.getCurrentPage()}getWidgetById(e){return this.project.getWidgetById(e)}getSelectedWidget(){return this.project.getWidgetById(this.editor.selectedWidgetIds[0])}getSelectedWidgets(){return this.editor.selectedWidgetIds.map(e=>this.getWidgetById(e)).filter(e=>!!e)}getSelectedProfile(){const e=G;return this.project.deviceModel&&e[this.project.deviceModel]||null}getCanvasDimensions(){const e=this.preferences.state.renderingMode||"direct";if(e==="oepl"||e==="opendisplay"){const n=this.project.protocolHardware,i=this.preferences.state.orientation;return i==="portrait"||i==="portrait_inverted"?{width:Math.min(n.width,n.height),height:Math.max(n.width,n.height)}:{width:Math.max(n.width,n.height),height:Math.min(n.width,n.height)}}return this.project.getCanvasDimensions(this.preferences.state.orientation||"landscape")}getCanvasShape(){return this.project.getCanvasShape()}getPagesPayload(){const e={...this.project.getPagesPayload(),currentPageIndex:this.currentPageIndex,...co(this.settings)};return e.deviceModel=this.project.deviceModel||void 0,e.customHardware=this.project.customHardware,e.protocolHardware=this.project.protocolHardware,e.device_model=this.project.deviceModel||void 0,e.custom_hardware=this.project.customHardware,e.protocol_hardware=this.project.protocolHardware,e}getSettings(){return this.settings}getManualYamlOverride(){return this.project.manualYamlOverride}setSettings(e){this.updateSettings(e)}updateProtocolHardware(e){Object.assign(this.project.state.protocolHardware,e),I(P.SETTINGS_CHANGED),I(P.PAGE_CHANGED,{index:this.currentPageIndex,forceFocus:!0})}saveToLocalStorage(){if(!W()){const e=this.getPagesPayload();localStorage.setItem("esphome-designer-layout",JSON.stringify(e))}}loadFromLocalStorage(){try{const e=localStorage.getItem("esphome-designer-layout");return e?JSON.parse(e):null}catch(e){return v.error("[loadFromLocalStorage] Parse error:",e),null}}setPages(e){this.project.setPages(e),I(P.STATE_CHANGED)}reorderWidget(e,n,i){this.pageManager.reorderWidget(e,n,i)}setCurrentPageIndex(e,n={}){this.pageManager.setCurrentPageIndex(e,n)}reorderPage(e,n){this.pageManager.reorderPage(e,n)}addPage(e=null){return this.pageManager.addPage(e)}deletePage(e){this.pageManager.deletePage(e)}duplicatePage(e){return this.pageManager.duplicatePage(e)}renamePage(e,n){this.pageManager.renamePage(e,n)}selectWidget(e,n=!1){this.selectionManager.selectWidget(e,n)}selectWidgets(e){this.selectionManager.selectWidgets(e)}selectAllWidgets(){this.selectionManager.selectAllWidgets()}deselectAll(){this.selectionManager.deselectAll()}toggleSelection(e){this.selectionManager.toggleSelection(e)}isWidgetSelected(e){return this.selectionManager.isWidgetSelected(e)}groupSelection(){this.selectionManager.groupSelection()}ungroupSelection(e=null){this.selectionManager.ungroupSelection(e)}alignSelectedWidgets(e){this.selectionManager.alignSelectedWidgets(e)}distributeSelectedWidgets(e){this.selectionManager.distributeSelectedWidgets(e)}updateSettings(e){const n={},i={};Object.keys(e).forEach(o=>{wt(o)?n[o]=e[o]:i[o]=e[o]}),Object.keys(n).length&&Object.entries(n).forEach(([o,r])=>this.secrets.set(o,String(r??""))),this.preferences.update(i),e.device_name&&(this.project.state.deviceName=e.device_name),e.device_model&&(this.project.state.deviceModel=e.device_model),I(P.STATE_CHANGED),(e.device_model||e.orientation||e.custom_hardware)&&I(P.PAGE_CHANGED,{index:this.currentPageIndex,forceFocus:!0})}setDeviceName(e){this.project.state.deviceName=e,this.updateLayoutIndicator(),I(P.STATE_CHANGED)}setDeviceModel(e){this.project.state.deviceModel=e,this.updateLayoutIndicator(),I(P.STATE_CHANGED),I(P.PAGE_CHANGED,{index:this.currentPageIndex,forceFocus:!0})}setCurrentLayoutId(e){this.project.state.currentLayoutId=e,this.updateLayoutIndicator(),I(P.STATE_CHANGED)}setManualYamlOverride(e,n={}){this.project.setManualYamlOverride(e,n)}clearManualYamlOverride(e={}){this.project.clearManualYamlOverride(e)}updateLayoutIndicator(){const e=document.getElementById("currentLayoutName");e&&(e.textContent=this.project.deviceName||this.project.currentLayoutId||"Unknown")}setSnapEnabled(e){this.preferences.setSnapEnabled(e)}setShowGrid(e){this.preferences.setShowGrid(e)}setShowDebugGrid(e){this.preferences.setShowDebugGrid(e)}setShowRulers(e){this.preferences.setShowRulers(e)}setZoomLevel(e){this.editor.setZoomLevel(e)}setCustomHardware(e){this.widgetManager.setCustomHardware(e)}addWidget(e,n=null){this.widgetManager.addWidget(e,n)}updateWidget(e,n){this.widgetManager.updateWidget(e,n)}updateWidgets(e,n){this.widgetManager.updateWidgets(e,n)}updateWidgetsProps(e,n){this.widgetManager.updateWidgetsProps(e,n)}deleteWidget(e=null){this.widgetManager.deleteWidget(e)}moveWidgetToPage(e,n,i=null,o=null){return this.widgetManager.moveWidgetToPage(e,n,i,o)}copyWidget(e=null){this.widgetManager.copyWidget(e)}pasteWidget(){this.widgetManager.pasteWidget()}createDropShadow(e){this.widgetManager.createDropShadow(e)}clearCurrentPage(e=!1){return this.pageManager.clearCurrentPage(e)}recordHistory(){this.historyManager.recordHistory()}replaceHistoryBaseline(){this.historyManager.replaceHistoryBaseline()}undo(){this.historyManager.undo()}redo(){this.historyManager.redo()}setInternalFlag(e,n){const i=this.$raw||this;i[String(e)]=n}restoreSnapshot(e){this.historyManager.restoreSnapshot(e)}canUndo(){return this.historyManager.canUndo()}canRedo(){return this.historyManager.canRedo()}syncWidgetOrderWithHierarchy(){this.widgetManager.syncWidgetOrderWithHierarchy()}syncWidgetVisibilityWithMode(){this.widgetManager.syncWidgetVisibilityWithMode()}_isWidgetCompatibleWithMode(e,n){return this.widgetManager.isWidgetCompatibleWithMode(e,n)}_checkRenderingModeForWidget(e){this.widgetManager.checkRenderingModeForWidget(e)}}const Bo=new No,Wo={set(t,e,n,i){return e==="snapEnabled"?(v.warn(`[StateProxy] Intercepted illegal write to '${String(e)}'. Automatically rerouting to setSnapEnabled().`),typeof t.setSnapEnabled=="function"&&t.setSnapEnabled(!!n),!0):(typeof e=="string"&&!["entityStates","_isRestoringHistory","isUndoRedoInProgress"].includes(e)&&typeof t[e]!="function"&&(v.warn(`[StateProxy] Illegal state mutation detected: AppState.${e} = ${String(n)}`),console.trace(`[StateProxy] Trace for illegal mutation of AppState.${e}`)),Reflect.set(t,e,n,i))}},p=new Proxy(Bo,Wo);class U{static getEffectiveDarkMode(){const n=p?.getCurrentPage?.()?.dark_mode;return n==="dark"?!0:n==="light"?!1:!!(p&&p.settings&&p.settings.dark_mode)}static getDefaultColor(){return U.getEffectiveDarkMode()?"white":"black"}static getDefaultBgColor(){return U.getEffectiveDarkMode()?"black":"white"}static getGridCellDefaults(){return{grid_cell_row_pos:null,grid_cell_column_pos:null,grid_cell_row_span:1,grid_cell_column_span:1,grid_cell_x_align:"STRETCH",grid_cell_y_align:"STRETCH"}}static isLvglWidget(e){return!!(e&&e.startsWith("lvgl_"))}static createWidget(e){const n=xe(),i=U.getDefaultBgColor(),o=U.getDefaultColor();let r={id:n,type:e,x:40,y:40,width:120,height:40,title:"",entity_id:"",locked:!1,props:{}};switch(e){case"nav_next_page":return r.props={title:"Next",color:"rgba(0, 128, 255, 0.2)",border_color:"#0080ff",nav_action:"next_page",icon:"F0142",icon_size:48},r.width=80,r.height=80,r;case"nav_previous_page":return r.props={title:"Previous",color:"rgba(0, 128, 255, 0.2)",border_color:"#0080ff",nav_action:"previous_page",icon:"F0141",icon_size:48},r.width=80,r.height=80,r;case"nav_reload_page":return r.props={title:"Reload",color:"rgba(0, 128, 255, 0.2)",border_color:"#0080ff",nav_action:"reload_page",icon:"F0450",icon_size:48},r.width=80,r.height=80,r}const a=q.get(e);return a&&a.defaults&&(r.props={...a.defaults},(r.props.color==="black"||r.props.color==="white")&&(r.props.color="theme_auto"),(r.props.text_color==="black"||r.props.text_color==="white")&&(r.props.text_color="theme_auto"),(r.props.bg_color==="black"||r.props.bg_color==="white")&&(r.props.bg_color=i),(r.props.background_color==="black"||r.props.background_color==="white")&&(r.props.background_color=i),(r.props.border_color==="black"||r.props.border_color==="white")&&(r.props.border_color=o),a.width&&(r.width=a.width),a.height&&(r.height=a.height),a.defaults.width&&(r.width=a.defaults.width),a.defaults.height&&(r.height=a.defaults.height),a.defaults.w&&(r.width=a.defaults.w),a.defaults.h&&(r.height=a.defaults.h)),U.isLvglWidget(e)&&(r.props={...U.getGridCellDefaults(),...r.props}),r}}let Le=null;class Hs{constructor(){this.isOpen=!1,this.selectedIndex=0,this.filteredWidgets=[],this.allWidgets=[],this.modal=null,this.input=null,this.resultsContainer=null,Le=this,this.init()}init(){this.createModal(),this.bindEvents()}discoverWidgets(){this.allWidgets=[];const e=document.querySelectorAll(".widget-category .item[data-widget-type]");if(e.length===0){v.warn("[QuickSearch] No widgets found in palette");return}e.forEach(n=>{const i=n.getAttribute("data-widget-type"),o=n.querySelector(".label"),r=o?o.textContent.trim():i,a=n.closest(".widget-category"),s=a?a.querySelector(".category-name"):null,l=s?s.textContent.trim():"Widgets";this.allWidgets.push({type:i,label:r,category:l,searchText:`${r} ${i} ${l}`.toLowerCase()})}),v.log(`[QuickSearch] Discovered ${this.allWidgets.length} widgets`)}createModal(){this.modal=document.createElement("div"),this.modal.id="quick-search-modal",this.modal.className="quick-search-modal hidden",this.modal.innerHTML=`
    ...
    `,X(n);const i=()=>n.remove(),o=()=>{i();try{typeof p.deletePage=="function"?p.deletePage(t):typeof O=="function"&&O("Error: AppState.deletePage not found","error")}catch(s){if(typeof O=="function"){const l=s instanceof Error?s.message:String(s);O(`Error deleting page: ${l}`,"error")}}};n.querySelectorAll(".close-btn").forEach(s=>s.onclick=i);const a=n.querySelector(".confirm-btn");a&&(a.onclick=o),n.onclick=s=>{s.target===n&&i()}}function zo(){if(!p){typeof O=="function"&&O("Error: Application State is not ready.","error");return}const e=document.createElement("div");e.className="modal-backdrop",e.style.display="flex",e.innerHTML=`
...
`.trim()}repairJson(e){let n=[],i=!1,o=!1;for(let a=0;a<e.length;a++){const s=e[a];if(o){o=!1;continue}if(s==="\\"){o=!0;continue}if(s==='"'){i=!i;continue}i||(s==="["||s==="{"?n.push(s==="["?"]":"}"):(s==="]"||s==="}")&&n.length>0&&n[n.length-1]===s&&n.pop())}let r=e;for(i&&(r+='"'),r=r.trim().replace(/,\s*$/,"");n.length>0;)r+=n.pop();return r}minifyWidget(e){const{id:n,type:i,x:o,y:r,width:a,height:s,...l}=e;return{id:n,type:i,x:o,y:r,width:a,height:s,...l}}}const Z=new ve;function Pa(){try{return globalThis.localStorage??null}catch{return null}}function Ia(){try{return globalThis.location?.origin||""}catch{return""}}function ka(t){return t?Array.isArray(t)?t.length:typeof t=="object"?Object.keys(t).length:0:0}class Ws{constructor(){const e=r=>document.getElementById(r),n=r=>document.getElementById(r),i=r=>document.getElementById(r),o=r=>document.getElementById(r);this.modal=e("editorSettingsModal"),this.closeBtn=e("editorSettingsClose"),this.doneBtn=e("editorSettingsDone"),this.snapToGrid=n("editorSnapToGrid"),this.showGrid=n("editorShowGrid"),this.showConditionalWidgets=n("editorShowConditionalWidgets"),this.lightMode=n("editorLightMode"),this.cIncludeComments=n("editorCIncludeComments"),this.autoSave=n("editorAutoSave"),this.refreshEntitiesBtn=o("editorRefreshEntities"),this.entityCountLabel=e("editorEntityCount"),this.gridOpacity=n("editorGridOpacity"),this.extendedLatinGlyphs=n("editorExtendedLatinGlyphs"),this.haManualUrl=n("haManualUrl"),this.haLlatToken=n("haLlatToken"),this.testHaBtn=o("editorTestHaBtn"),this.haTestResult=e("haTestResult"),this.haDeployedWarning=e("haDeployedWarning"),this.haCorsTip=e("haCorsTip"),this.aiProvider=i("aiProvider"),this.aiApiKeyGemini=n("aiApiKeyGemini"),this.aiApiKeyOpenai=n("aiApiKeyOpenai"),this.aiApiKeyOpenrouter=n("aiApiKeyOpenrouter"),this.aiApiKeyMinimax=n("aiApiKeyMinimax"),this.aiApiKeyGlm=n("aiApiKeyGlm"),this.aiModelFilter=n("aiModelFilter"),this.aiModelSelect=i("aiModelSelect"),this.aiRefreshModelsBtn=o("aiRefreshModelsBtn"),this.aiTestResult=e("aiTestResult"),this.aiKeyRows={gemini:e("aiKeyGeminiRow"),openai:e("aiKeyOpenaiRow"),openrouter:e("aiKeyOpenrouterRow"),minimax:e("aiKeyMinimaxRow"),glm:e("aiKeyGlmRow")}}init(){this.modal&&(this.closeBtn&&this.closeBtn.addEventListener("click",()=>this.close()),this.doneBtn&&this.doneBtn.addEventListener("click",()=>this.close()),this.setupListeners())}open(){if(!this.modal)return;const e=p.settings;this.snapToGrid&&(this.snapToGrid.checked=p.snapEnabled!==!1),this.showGrid&&(this.showGrid.checked=p.showGrid!==!1),this.showConditionalWidgets&&(this.showConditionalWidgets.checked=!!e.showConditionalWidgets),this.lightMode&&(this.lightMode.checked=!!e.editor_light_mode),this.cIncludeComments&&(this.cIncludeComments.checked=e.c_include_comments!==!1),this.autoSave&&(this.autoSave.checked=e.autoSaveEnabled!==!1),this.aiProvider&&(this.aiProvider.value=e.ai_provider||"gemini"),this.aiApiKeyGemini&&(this.aiApiKeyGemini.value=e.ai_api_key_gemini||""),this.aiApiKeyOpenai&&(this.aiApiKeyOpenai.value=e.ai_api_key_openai||""),this.aiApiKeyOpenrouter&&(this.aiApiKeyOpenrouter.value=e.ai_api_key_openrouter||""),this.aiApiKeyMinimax&&(this.aiApiKeyMinimax.value=e.ai_api_key_minimax||""),this.aiApiKeyGlm&&(this.aiApiKeyGlm.value=e.ai_api_key_glm||""),this.aiModelFilter&&(this.aiModelFilter.value=e.ai_model_filter||""),this.updateAIKeyVisibility(),this.refreshModelSelect(),this.gridOpacity&&(this.gridOpacity.value=String(e.grid_opacity!==void 0?e.grid_opacity:20));const n=e.glyphsets||["GF_Latin_Kernel"];document.querySelectorAll(".glyphset-checkbox").forEach(a=>{a.checked=n.includes(a.value)}),this.extendedLatinGlyphs&&(this.extendedLatinGlyphs.checked=!!e.extendedLatinGlyphs);const o=dt();this.haManualUrl&&(this.haManualUrl.value=Sn()||"",this.haManualUrl.disabled=o,this.haManualUrl.style.opacity=o?"0.5":"1"),this.haLlatToken&&(this.haLlatToken.value=En()||"",this.haLlatToken.disabled=o,this.haLlatToken.style.opacity=o?"0.5":"1"),this.haDeployedWarning&&this.haDeployedWarning.classList.toggle("hidden",!o),this.haCorsTip&&this.haCorsTip.classList.toggle("hidden",o),this.haTestResult&&(this.haTestResult.textContent=""),this.aiTestResult&&(this.aiTestResult.textContent="");const r=document.getElementById("haOriginPlaceholder");r&&(r.textContent=Ia()),this.updateEntityCount(),this.modal.classList.remove("hidden"),this.modal.style.display="flex"}close(){this.modal&&(this.modal.classList.add("hidden"),this.modal.style.display="none")}updateEntityCount(){if(this.entityCountLabel&&Q){const e=ka(Q);this.entityCountLabel.textContent=`${e} entities cached`}}setupListeners(){if(!this.modal)return;const e=this.snapToGrid;e&&e.addEventListener("change",()=>{p.setSnapEnabled(e.checked)});const n=this.showGrid;n&&n.addEventListener("change",()=>{p.setShowGrid(n.checked);const w=document.querySelector(".canvas-grid");w&&(w.style.display=n.checked?"block":"none")});const i=this.showConditionalWidgets;i&&i.addEventListener("change",()=>{p.updateSettings({showConditionalWidgets:i.checked}),I(P.STATE_CHANGED)});const o=this.lightMode;o&&o.addEventListener("change",()=>{const w=o.checked;p.updateSettings({editor_light_mode:w}),this.applyEditorTheme(w),I(P.STATE_CHANGED)});const r=this.cIncludeComments;r&&r.addEventListener("change",()=>{p.updateSettings({c_include_comments:r.checked})});const a=this.autoSave;a&&a.addEventListener("change",()=>{p.updateSettings({autoSaveEnabled:a.checked})});const s=this.gridOpacity;s&&s.addEventListener("input",()=>{const w=parseInt(s.value,10);p.updateSettings({grid_opacity:w})});const l=this.refreshEntitiesBtn;l&&l.addEventListener("click",async()=>{l.disabled=!0,l.textContent="Refreshing...",pe&&await pe(),this.updateEntityCount(),l.disabled=!1,l.textContent="â†» Refresh Entity List"});const c=this.haManualUrl;c&&c.addEventListener("change",()=>{wn(c.value.trim()),Bt()});const d=this.haLlatToken;d&&d.addEventListener("change",()=>{Xi(d.value.trim())});const u=this.testHaBtn;u&&u.addEventListener("click",async()=>{const w=this.haTestResult;u.disabled=!0,w&&(w.textContent="Testing...",w.style.color="var(--muted)");try{Bt();const E=await pe();E&&E.length>0?(w&&(w.textContent="âœ… Success!",w.style.color="var(--success)"),this.updateEntityCount()):w&&(w.innerHTML="âŒ Failed.<br>Did you add <strong>cors_allowed_origins</strong> to HA and <strong>restart</strong> it?",w.style.color="var(--danger)")}catch{w&&(w.innerHTML="âŒ Connection Error.<br>Check browser console.",w.style.color="var(--danger)")}finally{u.disabled=!1}});const h=this.aiProvider;h&&h.addEventListener("change",()=>{p.updateSettings({ai_provider:h.value}),this.updateAIKeyVisibility(),this.refreshModelSelect()});const g=(w,E)=>{const C=document.getElementById(w);C&&C.addEventListener("input",()=>p.updateSettings({[E]:C.value.trim()}))};g("aiApiKeyGemini","ai_api_key_gemini"),g("aiApiKeyOpenai","ai_api_key_openai"),g("aiApiKeyOpenrouter","ai_api_key_openrouter"),g("aiApiKeyMinimax","ai_api_key_minimax"),g("aiApiKeyGlm","ai_api_key_glm");const m=this.aiModelFilter;m&&m.addEventListener("input",()=>{p.updateSettings({ai_model_filter:m.value}),this.filterModels()});const f=this.aiModelSelect;f&&f.addEventListener("change",()=>{const w=p.settings.ai_provider||"gemini";p.updateSettings({[`ai_model_${w}`]:f.value})});const _=this.aiRefreshModelsBtn;_&&_.addEventListener("click",async()=>{const w=p.settings.ai_provider||"gemini";let E=p.settings[`ai_api_key_${w}`];const C=`aiApiKey${w.charAt(0).toUpperCase()+w.slice(1)}`,x=document.getElementById(C);if(x&&(E=x.value.trim(),p.updateSettings({[`ai_api_key_${w}`]:E})),!E){O("Please enter an API key first","error",3e3);return}_.disabled=!0,_.textContent="...";const k=this.aiTestResult;k&&(k.textContent="Testing...",k.style.color="var(--muted)");try{const L=await Z.fetchModels(w,E);Z.cache.models[w]=L,this.refreshModelSelect(),k&&(k.textContent=`âœ… Success! Found ${L.length} models.`,k.style.color="var(--success)")}catch{k&&(k.textContent="âŒ Failed. Check key/console.",k.style.color="var(--danger)")}finally{_.disabled=!1,_.textContent="Test & Load Models"}}),document.querySelectorAll(".glyphset-checkbox").forEach(w=>{w.addEventListener("change",()=>{const E=document.querySelectorAll(".glyphset-checkbox:checked"),C=Array.from(E).map(x=>x.value);p.updateSettings({glyphsets:C})})});const b=this.extendedLatinGlyphs;b&&b.addEventListener("change",()=>{p.updateSettings({extendedLatinGlyphs:b.checked})}),this.modal.querySelectorAll(".settings-category-header").forEach(w=>{w.addEventListener("click",()=>{const E=w.closest(".settings-category");if(!E)return;E.classList.contains("expanded")?E.classList.remove("expanded"):E.classList.add("expanded")})})}updateAIKeyVisibility(){const e=p.settings.ai_provider||"gemini";Object.keys(this.aiKeyRows).forEach(i=>{this.aiKeyRows[i]&&(this.aiKeyRows[i].style.display=i===e?"block":"none")})}async refreshModelSelect(){if(!this.aiModelSelect)return;const e=p.settings.ai_provider||"gemini";if(!Z||!Z.cache)return;if(!Z.cache.models[e]){const i=p.settings[`ai_api_key_${e}`]||"";Z.cache.models[e]=await Z.fetchModels(e,i)}this.filterModels()}filterModels(){const e=this.aiModelSelect;if(!e)return;const n=p.settings.ai_provider||"gemini",i=(p.settings.ai_model_filter||"").toLowerCase();if(!Z||!Z.cache)return;const o=Z.cache.models[n]||[],r=o.filter(s=>s.name.toLowerCase().includes(i)||s.id.toLowerCase().includes(i));e.innerHTML="",r.forEach(s=>{const l=document.createElement("option");l.value=s.id,l.textContent=s.name,e.appendChild(l)});const a=p.settings[`ai_model_${n}`];if(a){if(!r.some(s=>s.id===a)){const s=o.find(c=>c.id===a),l=document.createElement("option");l.value=a,l.textContent=s?s.name:a,e.insertBefore(l,e.firstChild)}e.value=a}}applyEditorTheme(e){e?document.documentElement.setAttribute("data-theme","light"):document.documentElement.removeAttribute("data-theme");try{const n=Pa();if(!n)return;n.setItem("reterminal-editor-theme",e?"light":"dark")}catch(n){v.log("Could not save theme preference:",n)}}}const Vn="snippet-selection-state-changed";let qn=null,Tt=!1;function Mt(){xt(new CustomEvent(Vn))}function Ke(){return qn}function Fs(t){qn=t,Mt()}function Je(){return Tt}function zs(t){Tt=t,Mt()}function Ys(){Tt=!1,Mt()}class La{constructor(){this.patterns=[{name:"comment",regex:/(#.*)/g},{name:"key",regex:/^(\s*)([^:\n]+)(:)/gm},{name:"string",regex:/("[^"]*"|'[^']*')/g},{name:"value",regex:/\b(true|false|null|[0-9]+(\.[0-9]+)?)\b/g},{name:"keyword",regex:/\b(lambda|script|on_.*|if|then|else|wait_until|delay)\b/g},{name:"tag",regex:/(![a-z_]+)/g}]}highlight(e,n=null){if(!e)return"";const i=/^(\s*(?:-\s+)?)([^:\n]+)(:)|(#.*)|("[^"]*"|'[^']*')|(![a-z_]+)|\b(lambda|script|on_[a-z_]+|if|then|else|wait_until|delay)\b|\b(true|false|null|[0-9]+(?:\.[0-9]+)?)\b|(\|[-+]?|>[-+]?)/gm,o=[];let r=0;for(const l of e.matchAll(i)){const c=l.index??0;c>r&&o.push({text:e.slice(r,c),className:null});const[,d,u,h,g,m,f,_,y,b]=l;d!==void 0?(o.push({text:d,className:null}),o.push({text:u,className:"hl-key"}),o.push({text:h,className:"hl-punc"})):g!==void 0?o.push({text:g,className:"hl-comment"}):m!==void 0?o.push({text:m,className:"hl-string"}):f!==void 0?o.push({text:f,className:"hl-tag"}):b!==void 0?o.push({text:b,className:"hl-punc"}):_!==void 0?o.push({text:_,className:"hl-keyword"}):y!==void 0&&o.push({text:y,className:"hl-value"}),r=c+l[0].length}r<e.length&&o.push({text:e.slice(r),className:null});let a=0;const s=n&&n.end>n.start?n:null;return o.map(l=>{const c=a,d=a+l.text.length;return a=d,this.renderSegment(l,c,d,s)}).join("")}renderSegment(e,n,i,o){if(!e.text)return"";if(!o||o.end<=n||o.start>=i)return this.wrapSegmentText(e.text,e.className,!1);const r=Math.max(o.start,n)-n,a=Math.min(o.end,i)-n;return[{text:e.text.slice(0,r),selected:!1},{text:e.text.slice(r,a),selected:!0},{text:e.text.slice(a),selected:!1}].map(l=>this.wrapSegmentText(l.text,e.className,l.selected)).join("")}wrapSegmentText(e,n,i){if(!e)return"";const o=this.escapeHtml(e),r=n?`<span class="${n}">${o}</span>`:o;return i?`<span class="hl-selected">${r}</span>`:r}escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}const Ta=new Set(["esphome","esp32","esp8266","psram","wifi","api","ota","logger","web_server","captive_portal","preferences","platformio_options","deep_sleep","substitutions"]);async function We(t){if(navigator.clipboard&&_i())try{await navigator.clipboard.writeText(t);return}catch{}const e=document.createElement("textarea");e.value=t,e.style.position="fixed",e.style.left="-999999px",e.style.top="-999999px",document.body.appendChild(e),e.focus(),e.select();try{if(!document.execCommand("copy"))throw new Error("Copy command was rejected")}finally{document.body.removeChild(e)}}function Fe(t,e,n=2e3){const i=t.innerHTML,o=t.style.minWidth;t.style.minWidth=t.offsetWidth+"px",t.textContent=e,globalThis.setTimeout(()=>{t.innerHTML=i,t.style.minWidth=o},n)}function Ma(t){const e=t.search(/^display:\s*$/m);if(e===-1)throw new Error("No display section found in output");const n=t.substring(e),i=n.match(/\n[a-z_]+:\s*(?:\n|$)/),r=(i?n.substring(0,i.index):n).match(/lambda:\s*\|-\n([\s\S]*?)$/);if(!r)throw new Error("No display lambda found in output");const s=r[1].split(`
...
`).trim()}function Oa(t){const e=t.match(/^(?:# ?)?([A-Za-z0-9_]+):(?:\s+#.*)?\s*$/);return e?e[1]:null}function Aa(t){const e=String(t||"").replace(/\r\n/g,`
`).split(`
`),n=[];let i=!1;for(const r of e){const a=Oa(r);a&&(i=Ta.has(a),i)||i||n.push(r)}const o=n.join(`
`).replace(/\n{3,}/g,`

`).trim();if(!o)throw new Error("No UI YAML remains after removing hardware/system sections");return o}function Da(t,e={}){const n=e.oeplEntityId||"open_epaper_link.0000000000000000",i=e.oeplDither??2;t.target.entity_id=n,t.data.dither=i;let o=`service: ${t.service}
`;return o+=`target:
...
`,o+=`  ttl: ${t.data.ttl}
`,o+=`  payload: >
`,o+=`    ${JSON.stringify(t.data.payload)}`,o}function Ga(t){const e=t==="OEPLAdapter",n=t==="OpenDisplayAdapter",i=t==="CAdapter",o=document.getElementById("oeplNotice");o&&o.classList.toggle("hidden",!e);const r=document.getElementById("odpNotice");if(r&&(r.classList.toggle("hidden",!n),n)){const h=r.querySelector("div");h&&(h.innerHTML="<strong>OpenDisplay YAML (ODP)</strong> - Copy this to Home Assistant > Developer Tools > Actions > <code>opendisplay.drawcustom</code>")}const a=document.querySelector(".code-panel-title");if(a){const h=a.querySelector("button");a.innerHTML="",h&&a.appendChild(h);let g=" ESPHome YAML";e&&(g=" OpenEpaperLink JSON"),n&&(g=" OpenDisplay YAML (ODP)"),i&&(g=" C/C++ Drawing Code"),a.appendChild(document.createTextNode(g))}const s=document.getElementById("copyOEPLServiceBtn");s&&(s.style.display=e?"inline-block":"none");const l=document.getElementById("copyODPServiceBtn");l&&(l.style.display=n?"inline-block":"none");const c=document.getElementById("copyUiYamlBtn");c&&(c.style.display=e||n||i?"none":"inline-block");const d=document.getElementById("copyLambdaBtn");d&&(d.style.display=e||n||i?"none":"inline-block");const u=document.getElementById("updateLayoutBtn");return u&&(u.style.display="inline-block"),{isOEPL:e,isODP:n,isC:i}}function Ha(t){return document.getElementById(t)}function Ot(t){return document.getElementById(t)}function be(t){return document.getElementById(t)}function Xn(t){return t instanceof Error?t.message:String(t)}function Kn(t){(Array.isArray(t?.importWarnings)?t.importWarnings:[]).forEach((n,i)=>{setTimeout(()=>O(n,"warning",4500),i*200)})}function Ra(t){const e=be("snippetFullscreenModal"),n=be("snippetFullscreenContainer"),i=be("snippetFullscreenContent"),o=be("snippetFullscreenHighlight"),r=Ot("snippetBox"),a=document.getElementById("toggleFullscreenHighlightBtn");if(!e||!n||!i||!o||!r)return;n.classList.toggle("highlighted",t.isHighlighted),a&&a.classList.toggle("active",t.isHighlighted),a&&!a.hasListener&&(a.addEventListener("click",()=>{t.isHighlighted=!t.isHighlighted,localStorage.setItem("esphome_designer_yaml_highlight",String(t.isHighlighted));const c=document.querySelector(".snippet-container"),d=Ha("toggleHighlightBtn");if(c&&c.classList.toggle("highlighted",t.isHighlighted),d&&d.classList.toggle("active",t.isHighlighted),n.classList.toggle("highlighted",t.isHighlighted),a.classList.toggle("active",t.isHighlighted),t.isHighlighted){const u=Je()?Ke():null;o.innerHTML=t.highlighter.highlight(s.value,u),t.updateHighlightLayer()}}),a.hasListener=!0);let s=i.querySelector("textarea");if(!s){i.innerHTML="",s=document.createElement("textarea"),s.className="snippet-box",s.style.width="100%",s.style.height="100%",s.style.background="transparent",s.spellcheck=!1,i.appendChild(s),s.addEventListener("scroll",()=>{o.scrollTop=s.scrollTop,o.scrollLeft=s.scrollLeft}),s.addEventListener("input",()=>{const d=s.value;r&&(r.value=d),typeof t.handleSnippetTextInput=="function"&&t.handleSnippetTextInput(d),t.isHighlighted&&(o.innerHTML=t.highlighter.highlight(d))});let c=e.querySelector(".modal-actions");if(c&&!c.querySelector("#fullscreenUpdateBtn")){const d=document.createElement("button");d.id="fullscreenUpdateBtn",d.className="btn btn-primary",d.textContent="Update Layout from YAML",d.onclick=()=>{const u=s.value;r.value=u,typeof t.handleSnippetTextInput=="function"&&t.handleSnippetTextInput(u),t.handleUpdateLayoutFromSnippetBox(),e.classList.add("hidden")},c.insertBefore(d,c.firstChild)}}const l=s;if(l){if(l.value=r.value||"",t.isHighlighted){const c=Je()?Ke():null;o.innerHTML=t.highlighter.highlight(l.value,c),setTimeout(()=>{o.scrollTop=l.scrollTop,o.scrollLeft=l.scrollLeft},50)}e.style.display="",e.classList.remove("hidden")}}async function Na(t){const e=Ot("importSnippetTextarea"),n=be("importSnippetError");if(!e)return;const i=e.value;if(i.trim())try{n&&(n.textContent="");let o;try{o=cn(i),v.log("[handleImportSnippet] Successfully used offline parser.")}catch(a){if(v.warn("[handleImportSnippet] Offline parser failed, falling back to backend:",a),W())o=await ho(i);else throw a}ue(o);const r=be("importSnippetModal");r&&(r.classList.add("hidden"),r.style.display="none"),O("Layout imported successfully","success"),Kn(o)}catch(o){v.error("Import failed:",o),n&&(n.textContent=`Error: ${Xn(o)}`)}}async function Ba(t){const e=Ot("snippetBox");if(!e)return;const n=e.value;if(n.trim()){if(t.lastGeneratedYaml&&n.trim()===t.lastGeneratedYaml.trim()){v.log("[handleUpdateLayoutFromSnippetBox] Skipping update: Snippet matches last generated state.");return}try{const i=p?.currentLayoutId||"reterminal_e1001",o=p?.deviceName||"Layout 1",r=p?.deviceModel||p?.settings?.device_model||"reterminal_e1001";v.log(`[handleUpdateLayoutFromSnippetBox] Preserving context - ID: ${i}, Name: ${o}`);const a=cn(n);if(!a)throw new Error("Could not parse layout from YAML");a.device_id=i,a.name=o,a.device_model=r,a.settings||(a.settings={}),a.settings.device_model=r,a.settings.device_name=o;const s=p?.settings?.dark_mode||!1;a.settings.dark_mode=s,t.suppressSnippetUpdate=!0,t.snippetDebounceTimer&&(clearTimeout(t.snippetDebounceTimer),t.snippetDebounceTimer=null),t.hasPendingManualSnippetChanges=!1,ue(a),typeof t.syncGeneratedSnippetBaseline=="function"&&await t.syncGeneratedSnippetBaseline(),typeof t.persistManualYamlOverride=="function"&&t.persistManualYamlOverride(n),t.suppressSnippetUpdate=!1,O("Layout updated from YAML","success"),Kn(a),(n.includes("lambda:")||n.includes("script:"))&&setTimeout(()=>{O("Note: Custom C++ (lambda/script) may not fully preview.","warning",4e3)},800)}catch(i){v.error("Update layout failed:",i),O(`Update failed: ${Xn(i)}`,"error"),t.suppressSnippetUpdate=!1}}}function V(t){return document.getElementById(t)}function te(t){return document.getElementById(t)}function fe(t){return document.getElementById(t)}function ze(t){return t instanceof Error?t.message:String(t)}class $s{constructor(e){this.adapter=e,this.highlighter=new La,this.suppressSnippetUpdate=!1,this.snippetDebounceTimer=null,this.generationCounter=0,this.lastGeneratedYaml="",this.hasPendingManualSnippetChanges=!1,this.isHighlighted=localStorage.getItem("esphome_designer_yaml_highlight")!=="false",this.init()}getPersistedManualYamlOverride(){return typeof p?.getManualYamlOverride=="function"?p.getManualYamlOverride()||"":p?.project?.state?.manualYamlOverride||""}refreshManualOverrideUi(e){const n=V("clearYamlOverrideBtn");n&&(n.style.display=e?"inline-block":"none")}setSnippetText(e){const n=te("snippetBox");n&&n.value!==e&&(n.value=e);const o=fe("snippetFullscreenContent")?.querySelector("textarea");o&&o.value!==e&&(o.value=e)}normalizeSnippetText(e){return String(e||"").replace(/\r\n/g,`
...
`,Fa=`    <aside class="sidebar" role="complementary" aria-label="Editor Sidebar">
...
`,Ya=`    <aside class="right-panel" role="complementary" aria-label="Widget Properties">
      <!-- Hierarchy Panel -->
    ...
    `,l){const g=o.querySelector(".hierarchy-group-toggle");g&&g.addEventListener("click",m=>{p.updateWidget(e.id,{expanded:e.expanded===!1}),m.stopPropagation()})}const c=o.querySelector(".hierarchy-item-label");c&&c.addEventListener("click",g=>{if((p.selectedWidgetIds||[]).includes(e.id)){const m=prompt("Rename:",s);m!==null&&m!==""&&m!==s&&p.updateWidget(e.id,{title:m}),g.stopPropagation()}}),o.addEventListener("click",g=>{const m=g.ctrlKey||g.shiftKey;p.selectWidget(e.id,m),g.stopPropagation()});const d=o.querySelector(".toggle-lock");d&&d.addEventListener("click",g=>{p.updateWidget(e.id,{locked:!e.locked}),g.stopPropagation()});const u=o.querySelector(".toggle-visibility");u&&u.addEventListener("click",g=>{p.updateWidget(e.id,{hidden:!e.hidden}),g.stopPropagation()});const h=o.querySelector(".delete-widget");return h&&h.addEventListener("click",g=>{confirm(`Delete widget "${s}"?`)&&p.deleteWidget(e.id),g.stopPropagation()}),o.addEventListener("dragstart",g=>{g.dataTransfer&&(t.draggedIndex=n,o.classList.add("dragging"),g.dataTransfer.setData("application/widget-id",e.id),g.dataTransfer.effectAllowed="move")}),o.addEventListener("dragend",()=>{if(o.classList.remove("dragging"),t.draggedIndex=null,!t.listContainer)return;t.listContainer.querySelectorAll(".hierarchy-item").forEach(m=>m.classList.remove("drag-over"))}),o.addEventListener("dragover",g=>{g.dataTransfer&&(g.preventDefault(),g.dataTransfer.dropEffect="move",o.classList.add("drag-over"))}),o.addEventListener("dragleave",()=>{o.classList.remove("drag-over")}),o.addEventListener("drop",g=>{if(!g.dataTransfer)return;g.preventDefault();const m=g.dataTransfer.getData("application/widget-id"),f=o.dataset.id;if(m===f)return;const _=p.getWidgetById(m),y=p.getWidgetById(f);if(!_||!y)return;const b=_.type==="group"?null:y.type==="group"?f:y.parentId||null;if(_.parentId!==b){const w={parentId:b};b&&y.type==="group"?p.updateWidget(m,{...w,expanded:!0}):p.updateWidget(m,w)}const S=parseInt(o.dataset.index||"-1",10);t.draggedIndex!==null&&p.reorderWidget(p.currentPageIndex,t.draggedIndex,S)}),o}function _s(t){const e=t.filter(i=>i.type==="group"||!i.parentId).reverse(),n=new Map;return t.forEach(i=>{!i.parentId||i.type==="group"||(n.has(i.parentId)||n.set(i.parentId,[]),n.get(i.parentId).push(i))}),{topLevel:e,childrenMap:n}}function vs(t,e,n){const i=t.findIndex(o=>o.id===e);if(i===-1)return!1;if(n==="front"){if(i>=t.length-1)return!1;const[o]=t.splice(i,1);return t.push(o),!0}if(n==="back"){if(i===0)return!1;const[o]=t.splice(i,1);return t.unshift(o),!0}return n==="up"?i>=t.length-1?!1:([t[i],t[i+1]]=[t[i+1],t[i]],!0):n==="down"?i===0?!1:([t[i],t[i-1]]=[t[i-1],t[i]],!0):!1}class cl{constructor(){this.listContainer=null,this.header=null,this.panel=null,this.controlsContainer=null,this.draggedIndex=null,this.render=this.render.bind(this),this.highlightSelected=this.highlightSelected.bind(this)}init(){if(this.listContainer=document.getElementById("hierarchyList"),this.header=document.getElementById("hierarchyHeader"),this.panel=document.getElementById("hierarchyPanel"),!this.listContainer||!this.header||!this.panel){v.error("[HierarchyView] Required DOM elements not found");return}this.controlsContainer=document.createElement("div"),this.controlsContainer.id="hierarchyControls",this.controlsContainer.className="hierarchy-controls",this.controlsContainer.style.padding="8px 8px",this.controlsContainer.style.borderTop="1px solid var(--border-subtle)",this.panel.appendChild(this.controlsContainer),this.bindEvents(),this.render(),this.renderHeaderActions(),v.log("[HierarchyView] Initialized")}renderHeaderActions(){if(!this.header)return;let e=this.header.querySelector(".hierarchy-header-toggles");if(!e){e=document.createElement("div"),e.className="hierarchy-header-toggles";const n=this.header.querySelector(".chevron");this.header.insertBefore(e,n||null);const i=this.createHeaderToggle("mdi-lock-outline","Toggle All Locks",()=>{const r=p.getCurrentPage()?.widgets||[],a=r.every(s=>s.locked);r.forEach(s=>p.updateWidget(s.id,{locked:!a}))}),o=this.createHeaderToggle("mdi-eye-outline","Toggle All Visibility",()=>{const r=p.getCurrentPage()?.widgets||[],a=r.every(s=>s.hidden);r.forEach(s=>p.updateWidget(s.id,{hidden:!a}))});e.appendChild(i),e.appendChild(o)}}createHeaderToggle(e,n,i){const o=document.createElement("div");return o.className="h-toggle",o.title=n,o.innerHTML=`<i class="mdi ${e}"></i>`,o.onclick=r=>{r.stopPropagation(),i()},o}bindEvents(){this.header.addEventListener("click",()=>this.toggleCollapse()),N(P.STATE_CHANGED,this.render),N(P.PAGE_CHANGED,this.render),N(P.SELECTION_CHANGED,this.highlightSelected)}toggleCollapse(){if(!this.panel||!this.header)return;const e=this.panel.classList.toggle("hidden"),n=this.header.querySelector(".chevron");n&&(n.style.transform=e?"rotate(-90deg)":"rotate(0deg)")}highlightSelected(){if(!this.listContainer)return;const e=p.selectedWidgetIds||[];this.listContainer.querySelectorAll(".hierarchy-item").forEach(i=>{e.includes(i.dataset.id)?i.classList.add("selected"):i.classList.remove("selected")}),this.renderControls()}render(){if(!this.listContainer||!this.controlsContainer)return;const e=p.getCurrentPage();if(!e)return;if(this.listContainer.innerHTML="",!e.widgets||e.widgets.length===0){this.listContainer.innerHTML='<div style="font-size: 10px; color: var(--muted); text-align: center; padding: 12px;">No widgets on this page</div>',this.controlsContainer.style.display="none";return}const{topLevel:n,childrenMap:i}=_s(e.widgets),o=(r,a=0)=>{const s=e.widgets.indexOf(r),l=this.createItem(r,s,a);this.listContainer.appendChild(l);const c=i.get(r.id);c&&r.expanded!==!1&&[...c].reverse().forEach(d=>o(d,a+1))};n.forEach(r=>o(r)),this.highlightSelected(),this.renderControls()}createItem(e,n,i=0){return ys(this,e,n,i)}renderControls(){gs(this,this.controlsContainer)}moveLayerOrder(e,n){const i=p.getCurrentPage();i&&vs(i.widgets,e.id,n)&&p.setPages(p.pages)}moveToFront(e){this.moveLayerOrder(e,"front")}moveToBack(e){this.moveLayerOrder(e,"back")}moveUp(e){this.moveLayerOrder(e,"up")}moveDown(e){this.moveLayerOrder(e,"down")}}function Ye(t){return!!(t?.isComingSoon||t?.isUnavailable)}function pl(t){if(!t.modelInput||!G)return;const e=t.modelInput.value;v.log("[DeviceSettings] Populating dropdown with",Object.keys(G).length,"profiles"),t.modelInput.innerHTML="";const n=Ct||[],i=[],o=[];Object.entries(G).forEach(([l,c])=>{c.isCustomProfile||c.isOfflineImport?o.push([l,c]):i.push([l,c])});const r=(l,c)=>{const d=document.createElement("option");d.value=l;let u=c.name||l;u=u.replace(/\s*\(Local\)\s*/gi,"").replace(/\s*\(untested\)\s*/gi,"").replace(/\s*\(coming soon\)\s*/gi,"").trim();const h=[];return(c.isCustomProfile||c.isOfflineImport)&&h.push("Imported"),Ye(c)?h.push("coming soon"):n.includes(l)||h.push("untested"),h.length>0&&(u+=` (${h.join(", ")})`),d.textContent=u,Ye(c)&&(d.disabled=!0,d.title=c.unavailableReason||"Coming soon",d.style.color="var(--text-dim)"),d};if(i.forEach(([l,c])=>t.modelInput.appendChild(r(l,c))),o.length>0&&i.length>0){const l=document.createElement("option");l.disabled=!0,l.textContent="?????? User-Imported / Custom ??????",l.style.fontWeight="bold",l.style.color="var(--text-dim)",t.modelInput.appendChild(l)}o.forEach(([l,c])=>t.modelInput.appendChild(r(l,c)));const a=document.createElement("option");a.value="custom",a.textContent="Custom Profile...",a.style.fontWeight="bold",a.style.color="var(--accent)",t.modelInput.appendChild(a);const s=G[e];if(e==="custom"||s&&!Ye(s))t.modelInput.value=e;else if(s&&Ye(s)||!t.modelInput.value||t.modelInput.selectedOptions[0]?.disabled){const l=Array.from(t.modelInput.options).find(c=>!c.disabled);t.modelInput.value=l?.value||"reterminal_e1001"}try{t.customHardwarePanel&&typeof t.customHardwarePanel.updateVisibility=="function"&&t.customHardwarePanel.updateVisibility()}catch(l){v.error("[DeviceSettingsView] Error in customHardwarePanel.updateVisibility:",l)}}function ul(t){if(t){try{const e=t.modeSleep?.checked,n=t.modeDaily?.checked,i=t.modeDeepSleep?.checked;t.sleepRow&&(t.sleepRow.style.display=e||i?"flex":"none"),t.dailyRefreshRow&&(t.dailyRefreshRow.style.display=n?"flex":"none"),t.deepSleepRow&&(t.deepSleepRow.style.display=i?"block":"none"),t.deepSleepOptionsRow&&(t.deepSleepOptionsRow.style.display=i?"flex":"none")}catch(e){v.error("[DeviceSettingsView] Error in power mode visibility:",e)}try{const e=p?.settings?.lcdEcoStrategy||"backlight_off";t.dimTimeoutRow&&(t.dimTimeoutRow.style.display=e==="dim_after_timeout"?"flex":"none")}catch(e){v.error("[DeviceSettingsView] Error in dim timeout visibility:",e)}try{const e=t.renderingModeInput?.value||p?.settings?.renderingMode||"direct",n=e==="lvgl"||e==="direct"||e==="c",i=e==="oepl"||e==="opendisplay";t.powerStrategySection&&(t.powerStrategySection.style.display=n?"block":"none"),t.protocolHardwareSection&&(t.protocolHardwareSection.style.display=i?"block":"none"),t.deviceModelField&&(t.deviceModelField.style.display=i?"none":"block")}catch(e){v.error("[DeviceSettingsView] Error in section visibility:",e)}try{const e=t.modeDaily?.checked,n=t.modeManual?.checked,i=!e&&!n;t.refreshIntervalRow&&(t.refreshIntervalRow.style.display=i?"block":"none"),t.autoCycleRow&&(t.autoCycleRow.style.display=t.autoCycleEnabled?.checked?"flex":"none")}catch(e){v.error("[DeviceSettingsView] Error in refresh/cycle visibility:",e)}try{if(t.deepSleepStayAwakeEntityRow){const e=document.getElementById("setting-deep-sleep-stay-awake");t.deepSleepStayAwakeEntityRow.style.display=e?.checked?"flex":"none"}}catch(e){v.error("[DeviceSettingsView] Error in deep sleep stay awake visibility:",e)}try{t.customHardwarePanel&&typeof t.customHardwarePanel.updateVisibility=="function"&&t.customHardwarePanel.updateVisibility()}catch(e){v.error("[DeviceSettingsView] Error in customHardwarePanel.updateVisibility:",e)}try{t.protocolHardwarePanel&&typeof t.protocolHardwarePanel.updateStrategyDisplay=="function"&&t.protocolHardwarePanel.updateStrategyDisplay()}catch(e){v.error("[DeviceSettingsView] Error in protocolHardwarePanel.updateStrategyDisplay:",e)}}}function Se(t){const e=document.createElement("div");return e.textContent=t||"",e.innerHTML}function ri(t){return!!(t?.isComingSoon||t?.isUnavailable)}function bs(t,e,n){if(t&&e&&e[t]){let o=e[t].name||t||"Unknown";return ri(e[t])?o+=" (coming soon)":n.includes(t)||(o+=" (untested)"),o}const i={reterminal_e1001:"E1001 (Mono)",reterminal_e1002:"E1002 (Color)",trmnl:"TRMNL",esp32_s3_photopainter:"PhotoPainter (7-Color)"};return t&&(i[t]||t)||"Unknown"}function hl(t,e,n,i){return t.map(o=>{const r=o.id===e,a=t.filter(s=>s.name===o.name).length>1;return`
                <tr style="border-bottom: 1px solid var(--border-subtle); ${r?"background: var(--accent-soft);":""}">
                    <td style="padding: 8px 4px;">
                        ...
                        ${a?'<br><span style="font-size: 9px; color: var(--muted);">'+Se(o.id)+"</span>":""}
                    </td>
                    ...
                    <td style="padding: 8px 4px; text-align: right;">
                        <div style="display: flex; gap: 4px; justify-content: flex-end;">
                            ...
                            ${!r&&t.length>1?`<button type="button" class="btn btn-sm btn-secondary" style="font-size: 10px; padding: 4px 8px; color: var(--danger);" data-action="delete" data-id="${o.id}" data-name="${Se(o.name)}">Delete</button>`:""}
                        </div>
                    </td>
                </tr>
        ...
        `}function Ss(t,e){return t?Object.entries(t).map(([n,i])=>{let o=i.name||n;const r=ri(i);r?o+=" (coming soon)":e.includes(n)||(o+=" (untested)");const a=r?` disabled title="${Se(i.unavailableReason||"Coming soon")}"`:"";return`<option value="${Se(n)}"${a}>${Se(o)}</option>`}).join(""):'<option value="reterminal_e1001">reTerminal E1001</option>'}function ws(t){return`
                <div class="modal" style="max-width: 400px;">
                    <div class="modal-header">
            ...
            `}function Dt(t){return document.getElementById(t)}function ai(t){return document.getElementById(t)}function re(t){const e=document.getElementById(t);if(!e)throw new Error(`Missing element: ${t}`);return e}function gl(){return Ss(G,Ct||[])}function ml(t){const e=document.getElementById("layoutManagerModal");if(e)return t.modal=e,e;const n=document.createElement("div");n.id="layoutManagerModal",n.className="modal-backdrop hidden",n.innerHTML=xs(),X(n),t.modal=n;const i=re("layoutManagerClose"),o=re("layoutManagerNew"),r=re("layoutManagerImport"),a=re("layoutManagerFileInput");i.addEventListener("click",()=>t.close()),o.addEventListener("click",()=>t.showNewLayoutDialog()),r.addEventListener("click",()=>{a.click()}),a.addEventListener("change",l=>t.handleFileImport(l)),n.addEventListener("click",l=>{l.target===n&&t.close()});const s=document.getElementById("layoutManagerTableBody");return s&&s.addEventListener("click",l=>{const c=l.target instanceof HTMLElement?l.target.closest("button"):null;if(!c)return;const{action:d,id:u,name:h}=c.dataset;d==="load"&&u&&t.loadLayout(u),d==="export"&&u&&t.exportLayout(u),d==="delete"&&u&&h&&t.deleteLayout(u,h)}),n}function Es(t){const e=document.getElementById("newLayoutModal");if(e)return e;const n=document.createElement("div");return n.id="newLayoutModal",n.className="modal-backdrop hidden",n.innerHTML=ws(t.generateDeviceOptions()),X(n),re("newLayoutClose").addEventListener("click",()=>{n.classList.add("hidden")}),re("newLayoutCancel").addEventListener("click",()=>{n.classList.add("hidden")}),re("newLayoutConfirm").addEventListener("click",()=>{t.handleCreateLayoutConfirm()}),re("newLayoutName").addEventListener("keydown",i=>{i.key==="Enter"?(i.preventDefault(),t.handleCreateLayoutConfirm()):i.key==="Escape"&&n.classList.add("hidden"),i.stopPropagation()}),n.addEventListener("click",i=>{if(i.target===n){const o=Dt("newLayoutName");document.activeElement!==o&&n.classList.add("hidden")}}),n}function fl(t){const e=Es(t),n=Dt("newLayoutName");if(!n)return;const i=t.layouts.length;n.value=`Layout ${i+1}`;const o=G?Object.keys(G)[0]:"reterminal_e1001",r=ai("newLayoutDeviceType");r&&(r.value=o),e.classList.remove("hidden"),setTimeout(()=>n.focus(),100)}function yl(t){const e=Dt("newLayoutName"),n=ai("newLayoutDeviceType"),i=e?.value.trim()||"",o=n?.value||"reterminal_e1001";if(!i){alert("Please enter a layout name.");return}const r=document.getElementById("newLayoutModal");r&&r.classList.add("hidden"),t.createLayout(i,o)}const si=t=>new Promise(e=>setTimeout(e,t));async function Cs(t){const e=await Y(`${t}/layouts`,{headers:z()});if(!e.ok)throw new Error(`Failed to load layouts: ${e.status}`);return e.json()}async function Ps(t,e){const n=await Y(`${t}/layouts/${e}`,{headers:z()});if(!n.ok)throw new Error(`Failed to load layout: ${n.status}`);return n.json()}async function Is(t,e){return Y(`${t}/layouts/${e}`,{method:"POST",headers:{...z(),"Content-Type":"text/plain"},body:JSON.stringify({action:"delete"})})}async function ks(t,e){return Y(`${t}/layouts`,{method:"POST",headers:{...z(),"Content-Type":"text/plain"},body:JSON.stringify(e)})}async function Ls(t,e,n,i){const o=`${t}/import${n?"?overwrite=true":""}`;return Y(o,{method:"POST",headers:i(),body:JSON.stringify(e)})}function Ts(t){return t instanceof Error?t.message:String(t)}function Ae(){return F||""}async function _l(t){if(!W()){t.setStatus("Not connected to Home Assistant","error");return}try{const e=await Cs(Ae());t.layouts=e.layouts||[],e.last_active_layout_id&&t.layouts.some(n=>n.id===e.last_active_layout_id)&&(!p?.currentLayoutId||p.currentLayoutId==="reterminal_e1001")&&t.layouts.find(i=>i.id===e.last_active_layout_id)&&e.last_active_layout_id!==p?.currentLayoutId&&(v.log(`[LayoutManager] Syncing to last active layout: ${e.last_active_layout_id}`),t.currentLayoutId=e.last_active_layout_id,p&&typeof p.setCurrentLayoutId=="function"&&p.setCurrentLayoutId(e.last_active_layout_id)),t.renderLayoutList()}catch(e){v.error("[LayoutManager] Error loading layouts:",e),t.setStatus("Failed to load layouts","error")}}async function vl(t,e){if(W())try{t.setStatus("Loading layout...","info");const n=await Ps(Ae(),e);n.device_id||(n.device_id=e),t.currentLayoutId=e,p&&typeof p.setCurrentLayoutId=="function"&&(p.setCurrentLayoutId(e),v.log(`[LayoutManager] Set currentLayoutId to: ${e}`));const i=document.getElementById("canvas");if(i){const o=i.querySelector(".canvas-grid");i.innerHTML="",o&&i.appendChild(o),v.log("[LayoutManager] Cleared canvas before loading layout")}document.querySelectorAll(".graph-axis-label").forEach(o=>o.remove()),typeof ue=="function"&&ue(n),p&&p.currentLayoutId!==e&&(p.setCurrentLayoutId(e),v.log(`[LayoutManager] Re-set currentLayoutId to: ${e} (was changed by loadLayoutIntoState)`)),typeof I=="function"&&typeof P<"u"&&I(P.LAYOUT_IMPORTED,n),t.setStatus(`Loaded: ${n.name||e}`,"success"),t.renderLayoutList(),setTimeout(()=>t.close(),500)}catch(n){v.error("[LayoutManager] Error loading layout:",n),t.setStatus("Failed to load layout","error")}}async function bl(t,e){if(!W())return;let n=null;try{const i=`${F}/export?id=${e}`,o=await Y(i,{headers:z()});if(!o.ok){const l=await o.json().catch(()=>({}));throw new Error(l.error||`Export failed: ${o.status}`)}const r=await o.json(),a=new Blob([JSON.stringify(r,null,2)],{type:"application/json"});n=URL.createObjectURL(a);const s=document.createElement("a");s.href=n,s.download=`${e}_layout.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),t.setStatus("Export started...","success")}catch(i){v.error("[LayoutManager] Error exporting layout:",i),t.setStatus("Failed to export layout","error")}finally{n&&URL.revokeObjectURL(n)}}async function xl(t,e,n){if(W()&&confirm(`Are you sure you want to delete "${n}"?

This cannot be undone.`)){t.setStatus("Deleting layout...","info");try{const i=await Is(Ae(),e);if(!i.ok){const o=await i.json().catch(()=>({}));if(o.error==="cannot_delete_last_layout"){t.setStatus("Cannot delete the last layout","error");return}throw new Error(o.error||`Delete failed: ${i.status}`)}t.setStatus(`Deleted: ${n}`,"success"),await t.loadLayouts()}catch(i){v.warn("[LayoutManager] Network error during delete, verifying if operation completed..."),await si(1500),await t.loadLayouts(),t.layouts.some(r=>r.id===e)?(v.error("[LayoutManager] Error deleting layout:",i),t.setStatus("Failed to delete layout","error")):(v.log("[LayoutManager] Layout was successfully deleted (verified after refresh)"),t.setStatus(`Deleted: ${n}`,"success"))}}}async function Sl(t,e,n="reterminal_e1001"){if(!W())return;let i=e.toLowerCase().replace(/\s+/g,"_").replace(/[^a-z0-9_]/g,"");i||(i="layout");const o=`${i}_${Date.now()}`;t.setStatus("Creating layout...","info");let r=!1;try{const d=await ks(Ae(),{id:o,name:e,device_type:n,device_model:n});if(!d.ok){const u=await d.json().catch(()=>({}));throw new Error(u.error||`Create failed: ${d.status}`)}r=!0}catch(d){if(v.warn("[LayoutManager] Network error during create, verifying if operation completed..."),await si(1500),await t.loadLayouts(),t.layouts.some(h=>h.id===o))v.log("[LayoutManager] Layout was successfully created (verified after refresh)"),r=!0;else{v.error("[LayoutManager] Error creating layout:",d),t.setStatus("Failed to create layout","error");return}}if(!r)return;t.setStatus(`Created: ${e}`,"success"),await t.loadLayouts();const a=G[n],s=a&&a.features&&a.features.epaper,l=a&&a.features&&a.features.lvgl,c=s&&!l?"direct":"lvgl";v.log(`[LayoutManager] New layout ${o} detected device type. isEpaper=${s}, hasLvgl=${l}. Setting initial renderingMode to: ${c}`),p&&(p.setPages([{id:"page_0",name:"Page 1",widgets:[]}]),p.setCurrentPageIndex(0),p.updateSettings({renderingMode:c,device_model:n}),v.log("[LayoutManager] Cleared state and set initial settings before loading new layout")),await t.loadLayout(o),p&&(p.setDeviceModel(n),typeof I=="function"&&typeof P<"u"&&I(P.STATE_CHANGED),v.log(`[LayoutManager] Created layout '${o}' with device_model: ${n}, pages: ${p.pages?.length}, widgets: ${p.getCurrentPage()?.widgets?.length||0}`))}async function wl(t,e){const n=e.target instanceof HTMLInputElement?e.target:null,i=n?.files?.[0];if(i){try{const o=await i.text(),r=JSON.parse(o);if(!r.pages&&!r.device_id){t.setStatus("Invalid layout file","error");return}await t.importLayout(r)}catch(o){v.error("[LayoutManager] Error importing file:",o),t.setStatus(`Failed to import file: ${Ts(o)}`,"error")}n&&(n.value="")}}async function El(t,e,n=!1){if(W())try{const i=await Ls(Ae(),e,n,z),o=await i.json();if(!i.ok){if(o.error==="layout_exists"){confirm(`A layout with ID "${o.existing_id}" already exists.

Do you want to overwrite it?`)&&await t.importLayout(e,!0);return}throw new Error(o.error||`Import failed: ${i.status}`)}t.setStatus(`Imported: ${o.name||o.id}`,"success"),await t.loadLayouts()}catch(i){v.error("[LayoutManager] Error importing layout:",i),t.setStatus("Failed to import layout","error")}}export{Ks as $,p as A,co as B,Fs as C,G as D,P as E,ft as F,zs as G,Je as H,Ys as I,q as J,Un as K,v as L,gi as M,pi as N,F as O,Y as P,z as Q,Et as R,Ct as S,Us as T,Qn as U,Xs as V,qs as W,Vs as X,js as Y,Xa as Z,Js as _,Pn as a,Zs as a0,Rs as a1,Ns as a2,Bs as a3,cl as a4,Ws as a5,K as a6,Hs as a7,$s as a8,us as a9,el as aa,Qs as ab,nl as ac,tl as ad,T as ae,U as af,ea as ag,Lt as ah,Zt as ai,ei as aj,As as ak,Ds as al,sl as am,al as an,ll as ao,ns as ap,il as aq,rl as ar,ol as as,is as at,Gs as au,ul as b,H as c,Z as d,I as e,ml as f,_l as g,W as h,Se as i,bs as j,vl as k,He as l,bl as m,xl as n,N as o,pl as p,Es as q,hl as r,O as s,fl as t,dl as u,yl as v,gl as w,Sl as x,wl as y,El as z};
