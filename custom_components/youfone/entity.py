...
class YoufoneBeEntity(CoordinatorEntity[YoufoneDataUpdateCoordinator]):
    """Base Youfone entity."""
    ...
    def __init__(
        ...
        self._attr_device_info = DeviceInfo(
            ...
            manufacturer=NAME,
            configuration_url=WEBSITE.replace("youfone.be", f"youfone.{item.country}"),
